...
public class VotingServer
{
  ...
  /**
   * Randomly choose (see m_nCardamount)
   *
   * @return no request
   */
   ...
   * are correct - it means that one left in very high probability is also
   * correct (see codedcards)
   *
   * @param rprim
   *        - set of r^-1 mod(mod) used to unblind
