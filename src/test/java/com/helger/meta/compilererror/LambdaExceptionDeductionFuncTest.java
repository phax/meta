...
/**
 * This is a dummy class to test for generic exceptions in combinations with Lambdas<br>
 * Wait for http://bugs.java.com/bugdatabase/view_bug.do?bug_id=JDK-8164613
 *
 * @author Philip Helger
 */
public final class LambdaExceptionDeductionFuncTest
{
  ...
  public interface IBaseGetterManual extends IBaseGetter
  {
    String get () throws IOException;
  }

  public interface IThrowingGetter <EX extends Exception> extends IBaseGetter
  {
    String get () throws EX;
  }

  public interface IThrowingGetterWorking <EX extends Exception>
  {
    String get () throws EX;
  }
