...
public enum EProject implements IProject
{
 ...
 PH_COMMONS (PH_COMMONS_PARENT_POM,
             ...
             EHasPages.FALSE,
             EHasWiki.FALSE,
             PH_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PH_JAXB (PH_COMMONS_PARENT_POM,
          "ph-jaxb",
          EProjectType.JAVA_LIBRARY,
          EHasPages.FALSE,
          EHasWiki.FALSE,
 ...
 PH_DATETIME_PARENT_POM (null, "ph-datetime-parent-pom", "ph-datetime", EProjectType.MAVEN_POM, EHasPages.FALSE, EHasWiki.FALSE, "4.2.0"),
 PH_DATETIME (PH_DATETIME_PARENT_POM,
              "ph-datetime",
              EProjectType.JAVA_LIBRARY,
              EHasPages.FALSE,
              EHasWiki.FALSE,
              PH_DATETIME_PARENT_POM.getLastPublishedVersionString ()),
 PH_HOLIDAY (PH_DATETIME_PARENT_POM,
             "ph-holiday",
             EProjectType.JAVA_LIBRARY,
             EHasPages.FALSE,
             EHasWiki.FALSE,
 ...
 PH_JSCOMPRESS_MAVEN_PLUGIN (null, "ph-jscompress-maven-plugin", EProjectType.MAVEN_PLUGIN, EHasPages.FALSE, EHasWiki.FALSE, "2.1.0"),
 ...
 PH_DB_API (PH_DB_PARENT_POM,
            "ph-db-api",
            EProjectType.JAVA_LIBRARY,
            EHasPages.FALSE,
            EHasWiki.FALSE,
            PH_DB_PARENT_POM.getLastPublishedVersionString ()),
 PH_DB_JDBC (PH_DB_PARENT_POM,
             "ph-db-jdbc",
             EProjectType.JAVA_LIBRARY,
             EHasPages.FALSE,
             EHasWiki.FALSE,
             PH_DB_PARENT_POM.getLastPublishedVersionString ()),
 PH_DB_JPA (PH_DB_PARENT_POM,
            "ph-db-jpa",
            EProjectType.JAVA_LIBRARY,
            EHasPages.FALSE,
            EHasWiki.FALSE,
 ...
 PH_HTML_PARENT_POM (null, "ph-html-parent-pom", "ph-html", EProjectType.MAVEN_POM, EHasPages.FALSE, EHasWiki.FALSE, "5.0.3"),
 PH_HTML (PH_HTML_PARENT_POM,
          "ph-html",
          EProjectType.JAVA_LIBRARY,
          EHasPages.FALSE,
          EHasWiki.FALSE,
          PH_HTML_PARENT_POM.getLastPublishedVersionString ()),
 PH_HTML_JSCODE (PH_HTML_PARENT_POM,
                 "ph-html-jscode",
                 EProjectType.JAVA_LIBRARY,
                 EHasPages.FALSE,
                 EHasWiki.FALSE,
                 PH_HTML_PARENT_POM.getLastPublishedVersionString ()),
 PH_HTML_JQUERY (PH_HTML_PARENT_POM,
                 "ph-html-jquery",
                 EProjectType.JAVA_LIBRARY,
                 EHasPages.FALSE,
                 EHasWiki.FALSE,
 ...
 PH_MASTERDATA (null, "ph-masterdata", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "4.0.2"),
 ...
 PH_OTON_PARENT_POM (null, "ph-oton-parent-pom", "ph-oton", EProjectType.MAVEN_POM, EHasPages.FALSE, EHasWiki.FALSE, "6.1.0"),
 PH_OTON_BASIC (PH_OTON_PARENT_POM,
                "ph-oton-basic",
                EProjectType.JAVA_LIBRARY,
                EHasPages.FALSE,
                EHasWiki.FALSE,
                PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_BOOTSTRAP3 (PH_OTON_PARENT_POM,
                     "ph-oton-bootstrap3",
                     EProjectType.JAVA_LIBRARY,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
                     PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_BOOTSTRAP3_PAGES (PH_OTON_PARENT_POM,
                           "ph-oton-bootstrap3-pages",
                           EProjectType.JAVA_LIBRARY,
                           EHasPages.FALSE,
                           EHasWiki.FALSE,
                           PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_BOOTSTRAP3_STUB (PH_OTON_PARENT_POM,
                          "ph-oton-bootstrap3-stub",
                          EProjectType.JAVA_LIBRARY,
                          EHasPages.FALSE,
                          EHasWiki.FALSE,
                          PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_BOOTSTRAP3_UICTRLS (PH_OTON_PARENT_POM,
                             "ph-oton-bootstrap3-uictrls",
                             EProjectType.JAVA_LIBRARY,
                             EHasPages.FALSE,
                             EHasWiki.FALSE,
                             PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_CONNECT (PH_OTON_PARENT_POM,
                  "ph-oton-connect",
                  EProjectType.JAVA_LIBRARY,
                  EHasPages.FALSE,
                  EHasWiki.FALSE,
                  PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_CORE (PH_OTON_PARENT_POM,
               "ph-oton-core",
               EProjectType.JAVA_LIBRARY,
               EHasPages.FALSE,
               EHasWiki.FALSE,
               PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_EXCHANGE (PH_OTON_PARENT_POM,
                   "ph-oton-exchange",
                   EProjectType.JAVA_LIBRARY,
                   EHasPages.FALSE,
                   EHasWiki.FALSE,
 ...
 PH_OTON_TINYMCE4 (PH_OTON_PARENT_POM,
                   "ph-oton-tinymce4",
                   EProjectType.JAVA_LIBRARY,
                   EHasPages.FALSE,
                   EHasWiki.FALSE,
                   PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_UICORE (PH_OTON_PARENT_POM,
                 "ph-oton-uicore",
                 EProjectType.JAVA_LIBRARY,
                 EHasPages.FALSE,
                 EHasWiki.FALSE,
                 PH_OTON_PARENT_POM.getLastPublishedVersionString ()),
 PH_OTON_UICTRLS (PH_OTON_PARENT_POM,
                  "ph-oton-uictrls",
                  EProjectType.JAVA_LIBRARY,
                  EHasPages.FALSE,
                  EHasWiki.FALSE,
 ...
 PH_FONTS (null, "ph-fonts", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "2.0.0"),
 ...
 PH_SCH2XSLT_MAVEN_PLUGIN (PH_SCHEMATRON_PARENT_POM,
                           ...
                           EHasPages.FALSE,
                           EHasWiki.FALSE,
                           PH_SCHEMATRON_PARENT_POM.getLastPublishedVersionString ()),
 PH_SCHEMATRON (PH_SCHEMATRON_PARENT_POM,
                "ph-schematron",
                EProjectType.JAVA_LIBRARY,
                EHasPages.TRUE,
                EHasWiki.FALSE,
                PH_SCHEMATRON_PARENT_POM.getLastPublishedVersionString ()),
 PH_SCHEMATRON_TESTFILES (PH_SCHEMATRON_PARENT_POM,
                          "ph-schematron-testfiles",
                          EProjectType.JAVA_LIBRARY,
                          EHasPages.FALSE,
                          EHasWiki.FALSE,
                          PH_SCHEMATRON_PARENT_POM.getLastPublishedVersionString ()),
 PH_SCHEMATRON_VALIDATOR (PH_SCHEMATRON_PARENT_POM,
 ...
 PH_UBL_PARENT_POM (null, "ph-ubl-parent-pom", "ph-ubl", EProjectType.MAVEN_POM, EHasPages.FALSE, EHasWiki.FALSE, "4.0.0"),
 PH_UBL_API (PH_UBL_PARENT_POM,
             "ph-ubl-api",
             EProjectType.JAVA_LIBRARY,
             EHasPages.FALSE,
             EHasWiki.FALSE,
             PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL_JAXB_PLUGIN (PH_UBL_PARENT_POM,
                     "ph-ubl-jaxb-plugin",
                     EProjectType.OTHER_PLUGIN,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
                     PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL_TESTFILES (PH_UBL_PARENT_POM,
                   "ph-ubl-testfiles",
                   EProjectType.JAVA_LIBRARY,
                   EHasPages.FALSE,
                   EHasWiki.FALSE,
                   PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL20 (PH_UBL_PARENT_POM,
           "ph-ubl20",
           EProjectType.JAVA_LIBRARY,
           EHasPages.FALSE,
           EHasWiki.FALSE,
           PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL20_CODELISTS (PH_UBL_PARENT_POM,
                     "ph-ubl20-codelists",
                     EProjectType.JAVA_LIBRARY,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
                     PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL21 (PH_UBL_PARENT_POM,
           "ph-ubl21",
           EProjectType.JAVA_LIBRARY,
           EHasPages.FALSE,
           EHasWiki.FALSE,
           PH_UBL_PARENT_POM.getLastPublishedVersionString ()),
 PH_UBL21_CODELISTS (PH_UBL_PARENT_POM,
                     "ph-ubl21-codelists",
                     EProjectType.JAVA_LIBRARY,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
 ...
 PH_EBINTERFACE (null, "ph-ebinterface", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.TRUE, "4.0.1"),
 ...
 AS2_LIB_PARENT_POM (null, "as2-lib-parent-pom", "as2-lib", EProjectType.MAVEN_POM, EHasPages.FALSE, EHasWiki.FALSE, "2.2.3"),
 AS2_LIB (AS2_LIB_PARENT_POM,
          "as2-lib",
          EProjectType.JAVA_LIBRARY,
          EHasPages.FALSE,
          EHasWiki.FALSE,
          AS2_LIB_PARENT_POM.getLastPublishedVersionString ()),
 AS2_PARTNERSHIP_MONGODB (AS2_LIB_PARENT_POM,
                          "as2-partnership-mongodb",
                          EProjectType.JAVA_LIBRARY,
                          EHasPages.FALSE,
                          EHasWiki.FALSE,
                          AS2_LIB_PARENT_POM.getLastPublishedVersionString ()),
 AS2_SERVLET (AS2_LIB_PARENT_POM,
              "as2-servlet",
              EProjectType.JAVA_LIBRARY,
              EHasPages.FALSE,
              EHasWiki.FALSE,
 ...
 AS2_SERVER (null, "as2-server", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "2.2.3"),

 AS2_PEPPOL_CLIENT (null, "as2-peppol-client", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "1.0.2"),
 ...
 PEPPOL_COMMONS (PEPPOL_COMMONS_PARENT_POM,
                 "peppol-commons",
                 EProjectType.JAVA_LIBRARY,
                 EHasPages.FALSE,
                 EHasWiki.FALSE,
                 PEPPOL_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_TESTFILES (PEPPOL_COMMONS_PARENT_POM,
                   "peppol-testfiles",
                   EProjectType.JAVA_LIBRARY,
                   EHasPages.FALSE,
                   EHasWiki.FALSE,
                   PEPPOL_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_SBDH (PEPPOL_COMMONS_PARENT_POM,
              "peppol-sbdh",
              EProjectType.JAVA_LIBRARY,
              EHasPages.FALSE,
              EHasWiki.FALSE,
              PEPPOL_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_SML_CLIENT (PEPPOL_COMMONS_PARENT_POM,
                    "peppol-sml-client",
                    EProjectType.JAVA_LIBRARY,
                    EHasPages.FALSE,
                    EHasWiki.FALSE,
                    PEPPOL_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_SMP_CLIENT (PEPPOL_COMMONS_PARENT_POM,
                    "peppol-smp-client",
                    EProjectType.JAVA_LIBRARY,
                    EHasPages.FALSE,
                    EHasWiki.FALSE,
 ...
 PEPPOL_LIME_API (PEPPOL_LIME_PARENT_POM,
                  ...
                  EHasPages.FALSE,
                  EHasWiki.FALSE,
                  PEPPOL_LIME_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_LIME_CLIENT (PEPPOL_LIME_PARENT_POM,
                     "peppol-lime-client",
                     EProjectType.JAVA_LIBRARY,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
                     PEPPOL_LIME_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_LIME_SERVER (PEPPOL_LIME_PARENT_POM,
                     "peppol-lime-server",
                     EProjectType.JAVA_WEB_APPLICATION,
                     EHasPages.FALSE,
                     EHasWiki.FALSE,
 ...
 PEPPOL_DIRECTORY_API (PEPPOL_DIRECTORY_PARENT_POM,
                       "peppol-directory-api",
                       EProjectType.JAVA_LIBRARY,
                       EHasPages.FALSE,
                       EHasWiki.FALSE,
                       PEPPOL_DIRECTORY_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_DIRECTORY_INDEXER (PEPPOL_DIRECTORY_PARENT_POM,
 ...
 PEPPOL_DIRECTORY_PUBLISHER (PEPPOL_DIRECTORY_PARENT_POM,
                             ...
                             EHasWiki.FALSE,
                             PEPPOL_DIRECTORY_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_DIRECTORY_CLIENT (PEPPOL_DIRECTORY_PARENT_POM,
