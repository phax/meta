...
public enum EProject implements IProject
{
  ...
  PHASE4_PROFILE_BDEW (PHASE4_PARENT_POM, "phase4-profile-bdew", EProjectType.JAVA_LIBRARY, null),
  ...
  PHASE4_BDEW_CLIENT (PHASE4_PARENT_POM, "phase4-bdew-client", EProjectType.JAVA_LIBRARY, null),
