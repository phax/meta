...
public enum EProject implements IProject
{
  ...
  PEPPOL_COMMONS ("peppol-commons", EProjectType.JAVA_LIBRARY, EIsDeprecated.FALSE, EHasPages.FALSE, EHasWiki.FALSE, "3.1.1"),
  ...
  PEPPOL_SML_CLIENT ("peppol-sml-client", EProjectType.JAVA_LIBRARY, EIsDeprecated.FALSE, EHasPages.FALSE, EHasWiki.FALSE, "3.1.1"),
