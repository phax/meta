...
public enum EProject implements IProject
{
  ...
  PH_BDVE_JSON (PH_BDVE_PARENT_POM, "ph-bdve-json", EProjectType.JAVA_LIBRARY),

  PH_BDVE_RULES_PARENT_POM (null,
                            IProject.DEFAULT_PROJECT_OWNER,
                            ...
                            "1.0.14",
                            EJDK.JDK8),
  PH_BDVE_RULES_CII (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-cii", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_CIUS_PT (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-cius-pt", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_EBINTERFACE (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-ebinterface", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_EHF (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-ehf", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_EN16931 (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-en16931", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_ENERGIEEFACTUUR (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-energieefactuur", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_FACTURAE (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-facturae", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_FATTURAPA (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-fatturapa", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_FINVOICE (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-finvoice", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_OIOUBL (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-oioubl", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_PEPPOL (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-peppol", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_SIMPLERINVOICING (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-simplerinvoicing", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_SVEFAKTURA (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-svefaktura", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_TEAPPS (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-teapps", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_UBL (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-ubl", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_UBLBE (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-ublbe", EProjectType.JAVA_LIBRARY),
  PH_BDVE_RULES_XRECHNUNG (PH_BDVE_RULES_PARENT_POM, "ph-bdve-rules-xrechnung", EProjectType.JAVA_LIBRARY),
