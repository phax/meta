...
public enum EProject implements IProject
{
  ...
  PH_OTON_APP (PH_OTON_PARENT_POM, "ph-oton-app", EProjectType.JAVA_LIBRARY, (String) null),
  PH_OTON_AUDIT (PH_OTON_PARENT_POM, "ph-oton-audit", EProjectType.JAVA_LIBRARY, (String) null),
  PH_OTON_AJAX (PH_OTON_PARENT_POM, "ph-oton-ajax", EProjectType.JAVA_LIBRARY, (String) null),
  PH_OTON_API (PH_OTON_PARENT_POM, "ph-oton-api", EProjectType.JAVA_LIBRARY, (String) null),
  ...
  PHOSS_SMP_PARENT_POM (null,
                        ...
                        null,
                        EJDK.JDK8),
  PHOSS_SMP_LIBRARY (PHOSS_SMP_PARENT_POM, "phoss-smp-backend", EProjectType.JAVA_LIBRARY),
  PHOSS_SMP_SQL (PHOSS_SMP_PARENT_POM, "phoss-smp-backend-sql", EProjectType.JAVA_LIBRARY),
  PHOSS_SMP_XML (PHOSS_SMP_PARENT_POM, "phoss-smp-backend-xml", EProjectType.JAVA_LIBRARY),
