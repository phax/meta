...
public enum EProject implements IProject
{
 ...
 PH_VALIDATION (PH_MASTERDATA_PARENT_POM,
                "ph-validation",
                EProjectType.JAVA_LIBRARY,
                EHasPages.FALSE,
                EHasWiki.FALSE,
                PH_MASTERDATA_PARENT_POM.getLastPublishedVersionString ()),
 PH_MASTERDATA (PH_MASTERDATA_PARENT_POM,
                "ph-masterdata",
                EProjectType.JAVA_LIBRARY,
                EHasPages.FALSE,
                EHasWiki.FALSE,
                PH_MASTERDATA_PARENT_POM.getLastPublishedVersionString ()),
 PH_MASTERDATA_VALIDATION (PH_MASTERDATA_PARENT_POM,
