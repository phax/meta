...
public enum EProject implements IProject
{
  ...
  PH_CACHE (PH_COMMONS_PARENT_POM, "ph-cache", EProjectType.JAVA_LIBRARY),
  ...
  PH_CONFIG_JSON (PH_COMMONS_PARENT_POM, "ph-config-json", EProjectType.JAVA_LIBRARY),
  PH_CSV (PH_COMMONS_PARENT_POM, "ph-csv", EProjectType.JAVA_LIBRARY),
  ...
  PH_DIAGNOSTICS (PH_COMMONS_PARENT_POM, "ph-diagnostics", EProjectType.JAVA_LIBRARY),
  PH_GRAPH (PH_COMMONS_PARENT_POM, "ph-graph", EProjectType.JAVA_LIBRARY),
  PH_HTTP (PH_COMMONS_PARENT_POM, "ph-http", EProjectType.JAVA_LIBRARY),
  PH_IO (PH_COMMONS_PARENT_POM, "ph-io", EProjectType.JAVA_LIBRARY),
  ...
  PH_MIME (PH_COMMONS_PARENT_POM, "ph-mime", EProjectType.JAVA_LIBRARY),
  ...
  PH_STATISTICS (PH_COMMONS_PARENT_POM, "ph-statistics", EProjectType.JAVA_LIBRARY),
  PH_TEXT (PH_COMMONS_PARENT_POM, "ph-text", EProjectType.JAVA_LIBRARY),
  PH_TREE (PH_COMMONS_PARENT_POM, "ph-tree", EProjectType.JAVA_LIBRARY),
  PH_TYPECONVERT (PH_COMMONS_PARENT_POM, "ph-typeconvert", EProjectType.JAVA_LIBRARY),
  PH_UNITTEST_SUPPORT (PH_COMMONS_PARENT_POM, "ph-unittest-support", EProjectType.JAVA_LIBRARY),
  PH_UNITTEST_SUPPORT_EXT (PH_COMMONS_PARENT_POM, "ph-unittest-support-ext", EProjectType.JAVA_LIBRARY),
  PH_URL (PH_COMMONS_PARENT_POM, "ph-url", EProjectType.JAVA_LIBRARY),
  ...
  PH_TELEMETRY_PARENT_POM (null,
                           EProjectOwner.PROJECT_OWNER_PHAX,
                           "ph-telemetry-parent-pom",
                           "ph-telemetry",
                           EProjectType.MAVEN_POM,
                           EHasPages.FALSE,
                           EHasWiki.FALSE,
  ...
  PH_TELEMETRY_OTEL (PH_TELEMETRY_PARENT_POM, "ph-telemetry-otel", EProjectType.JAVA_LIBRARY),

  JCODEMODEL_PARENT_POM (null,
                         EProjectOwner.PROJECT_OWNER_PHAX,
  ...
  PH_FONTS_TEST (PH_FONTS_PARENT_POM, "ph-fonts-test", EProjectType.JAVA_LIBRARY),
  ...
  PH_FONTS_KURINTO_MONO (PH_FONTS_PARENT_POM, "ph-fonts-kurinto-mono", EProjectType.JAVA_LIBRARY),
  PH_FONTS_KURINTO_SANS (PH_FONTS_PARENT_POM, "ph-fonts-kurinto-sans", EProjectType.JAVA_LIBRARY),
  ...
  PH_FONTS_NOTO_SANS_TC (PH_FONTS_PARENT_POM, "ph-fonts-noto-sans-tc", EProjectType.JAVA_LIBRARY),
  ...
  PH_FONTS_SOURCE_SANS3 (PH_FONTS_PARENT_POM, "ph-fonts-source-sans3", EProjectType.JAVA_LIBRARY),
  ...
  PH_TOTP_PARENT_POM (null,
                      ...
                      "2.1.0",
                      EJDK.JDK17),
  PH_TOTP (PH_TOTP_PARENT_POM, "ph-totp", EProjectType.JAVA_LIBRARY),
  PH_TOTP_QRCODE (PH_TOTP_PARENT_POM, "ph-totp-qrcode", EProjectType.JAVA_LIBRARY),
  ...
  PH_CII_D22B (PH_CII_PARENT_POM, "ph-cii-d22b", EProjectType.JAVA_LIBRARY),
  PH_CII_D25A (PH_CII_PARENT_POM, "ph-cii-d25a", EProjectType.JAVA_LIBRARY),
  ...
  PH_UBL25 (PH_UBL_PARENT_POM, "ph-ubl25", EProjectType.JAVA_LIBRARY),
  PH_UBL25_CODELISTS (PH_UBL_PARENT_POM, "ph-ubl25-codelists", EProjectType.JAVA_LIBRARY),
  ...
  PH_DB_FLYWAY (PH_DB_PARENT_POM, "ph-db-flyway", EProjectType.JAVA_LIBRARY),
  ...
  PH_OTON_MGRS (PH_OTON_PARENT_POM, "ph-oton-mgrs", EProjectType.JAVA_LIBRARY),
  ...
  PH_OTON_ICON_PARENT_POM (null,
                           EProjectOwner.PROJECT_OWNER_PHAX,
                           "ph-oton-icon-parent-pom",
                           "ph-oton-icon",
                           EProjectType.MAVEN_POM,
                           EHasPages.FALSE,
                           EHasWiki.FALSE,
                           "1.0.1",
                           EJDK.JDK17),
  PH_OTON_ICON_FONTAWESOME4 (PH_OTON_ICON_PARENT_POM, "ph-oton-icon-fontawesome4", EProjectType.JAVA_LIBRARY),
  PH_OTON_ICON_FONTAWESOME5 (PH_OTON_ICON_PARENT_POM, "ph-oton-icon-fontawesome5", EProjectType.JAVA_LIBRARY),
  PH_OTON_ICON_FONTAWESOME6 (PH_OTON_ICON_PARENT_POM, "ph-oton-icon-fontawesome6", EProjectType.JAVA_LIBRARY),
  PH_OTON_ICON_MATERIALDESIGN (PH_OTON_ICON_PARENT_POM, "ph-oton-icon-materialdesign", EProjectType.JAVA_LIBRARY),
  PH_OTON_ICON_BOOTSTRAP (PH_OTON_ICON_PARENT_POM, "ph-oton-icon-bootstrap", EProjectType.JAVA_LIBRARY),
  ...
  PH_OTON_BOOTSTRAP4_PARENT_POM (null,
                                 EProjectOwner.PROJECT_OWNER_PHAX,
                                 ...
                                 "10.2.2",
                                 EJDK.JDK17),
  PH_OTON_BOOTSTRAP4 (PH_OTON_BOOTSTRAP4_PARENT_POM, "ph-oton-bootstrap4", EProjectType.JAVA_LIBRARY),
  PH_OTON_BOOTSTRAP4_DEMO (PH_OTON_BOOTSTRAP4_PARENT_POM, "ph-oton-bootstrap4-demo", EProjectType.JAVA_WEB_APPLICATION),
  PH_OTON_BOOTSTRAP4_PAGES (PH_OTON_BOOTSTRAP4_PARENT_POM, "ph-oton-bootstrap4-pages", EProjectType.JAVA_LIBRARY),
  PH_OTON_BOOTSTRAP4_STUB (PH_OTON_BOOTSTRAP4_PARENT_POM, "ph-oton-bootstrap4-stub", EProjectType.JAVA_LIBRARY),
  PH_OTON_BOOTSTRAP4_UICTRLS (PH_OTON_BOOTSTRAP4_PARENT_POM, "ph-oton-bootstrap4-uictrls", EProjectType.JAVA_LIBRARY),

  PH_OTON_BOOTSTRAP5_PARENT_POM (null,
                                 EProjectOwner.PROJECT_OWNER_PHAX,
                                 "ph-oton-bootstrap5-parent-pom",
                                 "ph-oton-bootstrap5",
                                 EProjectType.MAVEN_POM,
                                 EHasPages.FALSE,
                                 EHasWiki.FALSE,
  ...
  PH_OTON_BOOTSTRAP5_PAGES (PH_OTON_BOOTSTRAP5_PARENT_POM, "ph-oton-bootstrap5-pages", EProjectType.JAVA_LIBRARY),
  PH_OTON_BOOTSTRAP5_STUB (PH_OTON_BOOTSTRAP5_PARENT_POM, "ph-oton-bootstrap5-stub", EProjectType.JAVA_LIBRARY),
  PH_OTON_BOOTSTRAP5_UICTRLS (PH_OTON_BOOTSTRAP5_PARENT_POM, "ph-oton-bootstrap5-uictrls", EProjectType.JAVA_LIBRARY),
  ...
  PH_SCHEMATRON_MODEL (PH_SCHEMATRON_PARENT_POM, "ph-schematron-model", EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_XSLT (PH_SCHEMATRON_PARENT_POM, "ph-schematron-xslt", EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_ISOSCH (PH_SCHEMATRON_PARENT_POM, "ph-schematron-isosch", EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_SCHXSLT (PH_SCHEMATRON_PARENT_POM, "ph-schematron-schxslt", EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_SCHXSLT2 (PH_SCHEMATRON_PARENT_POM, "ph-schematron-schxslt2", EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_PURE_XPATH (PH_SCHEMATRON_PARENT_POM,
                            "ph-schematron-pure",
                            "ph-schematron-pure-xpath",
                            EProjectType.JAVA_LIBRARY),
  PH_SCHEMATRON_PURE_XSLT (PH_SCHEMATRON_PARENT_POM, "ph-schematron-pure-xslt", EProjectType.JAVA_LIBRARY),
  ...
  PHASE2_SERVER (PHASE2_PARENT_POM, "phase2-server", EProjectType.JAVA_LIBRARY),
  PHASE2_DEMO_WEBAPP (PHASE2_PARENT_POM, "phase2-demo-webapp", EProjectType.JAVA_WEB_APPLICATION),
  PHASE2_DEMO_SPRING_BOOT (PHASE2_PARENT_POM, "phase2-demo-spring-boot", EProjectType.JAVA_APPLICATION),
  ...
  PHIVE_VES_REPO (PHIVE_PARENT_POM, "phive-ves-repo", EProjectType.JAVA_LIBRARY),
  ...
  PEPPOL_COMMONS_PARENT_POM (null,
                             ...
                             "13.0.0",
                             EJDK.JDK17),
  EDELIVERY_COMMONS (PEPPOL_COMMONS_PARENT_POM, "edelivery-commons", EProjectType.JAVA_LIBRARY),
  PEPPOL_ID_DATATYPES (PEPPOL_COMMONS_PARENT_POM, "peppol-id-datatypes", EProjectType.JAVA_LIBRARY),
  EDELIVERY_ID (PEPPOL_COMMONS_PARENT_POM, "edelivery-id", EProjectType.JAVA_LIBRARY),
  PEPPOL_ID (PEPPOL_COMMONS_PARENT_POM, "peppol-id", EProjectType.JAVA_LIBRARY),
  BDXR_ID (PEPPOL_COMMONS_PARENT_POM, "bdxr-id", EProjectType.JAVA_LIBRARY),
  PEPPOL_ID_CHECKS (PEPPOL_COMMONS_PARENT_POM, "peppol-id-checks", EProjectType.JAVA_LIBRARY),
  ...
  EDELIVERY_SBDH (PEPPOL_COMMONS_PARENT_POM, "edelivery-sbdh", EProjectType.JAVA_LIBRARY),
  ...
  SMP_CLIENT_BASE (PEPPOL_COMMONS_PARENT_POM, "smp-client-base", EProjectType.JAVA_LIBRARY),
  ...
  PEPPOL_REPORTING_TEST (PEPPOL_REPORTING_PARENT_POM, "peppol-reporting-test", EProjectType.JAVA_LIBRARY),
  ...
  PEPPOL_AP_SUPPORT_PARENT_POM (null,
                                EProjectOwner.PROJECT_OWNER_PHAX,
  ...
  PEPPOL_OM_PARENT_POM (null,
                        EProjectOwner.PROJECT_OWNER_PHAX,
                        "peppol-om-parent-pom",
                        "peppol-om",
                        EProjectType.MAVEN_POM,
                        EHasPages.FALSE,
                        EHasWiki.FALSE,
                        "1.2.2",
                        EJDK.JDK17),
  PEPPOL_OM_TESTFILES (PEPPOL_OM_PARENT_POM, "peppol-om-testfiles", EProjectType.JAVA_LIBRARY),
  PEPPOL_OM_TDD_DATATYPES (PEPPOL_OM_PARENT_POM, "peppol-om-tdd-datatypes", EProjectType.JAVA_LIBRARY),
  PEPPOL_OM_TDD (PEPPOL_OM_PARENT_POM, "peppol-om-tdd", EProjectType.JAVA_LIBRARY),

  PEPPOL_SK_PARENT_POM (null,
                        EProjectOwner.PROJECT_OWNER_PHAX,
                        "peppol-sk-parent-pom",
                        "peppol-sk",
                        EProjectType.MAVEN_POM,
                        EHasPages.FALSE,
                        EHasWiki.FALSE,
                        "0.2.2",
                        EJDK.JDK17),
  PEPPOL_SK_TESTFILES (PEPPOL_SK_PARENT_POM, "peppol-sk-testfiles", EProjectType.JAVA_LIBRARY),
  PEPPOL_SK_TDD_DATATYPES (PEPPOL_SK_PARENT_POM, "peppol-sk-tdd-datatypes", EProjectType.JAVA_LIBRARY),
  PEPPOL_SK_TDD (PEPPOL_SK_PARENT_POM, "peppol-sk-tdd", EProjectType.JAVA_LIBRARY),

  PEPPOL_UAE_PARENT_POM (null,
                         EProjectOwner.PROJECT_OWNER_PHAX,
                         "peppol-uae-parent-pom",
                         "peppol-uae",
                         EProjectType.MAVEN_POM,
                         EHasPages.FALSE,
                         EHasWiki.FALSE,
  ...
  PEPPOL_UAE_TDD (PEPPOL_UAE_PARENT_POM, "peppol-uae-tdd", EProjectType.JAVA_LIBRARY),

  PEPPOL_VIDA_PARENT_POM (null,
                          EProjectOwner.PROJECT_OWNER_PHAX,
                          "peppol-vida-parent-pom",
                          "peppol-vida",
                          EProjectType.MAVEN_POM,
                          EHasPages.FALSE,
                          EHasWiki.FALSE,
  ...
  PEPPOL_VIDA_TDD (PEPPOL_VIDA_PARENT_POM, "peppol-vida-tdd", EProjectType.JAVA_LIBRARY),

  PHIVE_RULES_SHARED (null,
                      EProjectOwner.PROJECT_OWNER_PHAX,
                      "phive-rules-shared",
                      "phive-rules-shared",
                      EProjectType.JAVA_LIBRARY,
  ...
  PHIVE_RULES_FOUNDATIONS_PARENT_POM (null,
                                      EProjectOwner.PROJECT_OWNER_PHAX,
                                      "phive-rules-foundations-parent-pom",
                                      ...
                                      "5.0.4",
                                      EJDK.JDK17),
  PHIVE_RULES_CII (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-cii", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_CRS (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-crs", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_EBINTERFACE (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-ebinterface", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_FACTURAE (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-facturae", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_FATTURAPA (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-fatturapa", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_FINVOICE (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-finvoice", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_KSEF (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-ksef", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_OSA (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-osa", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_TEAPPS (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-teapps", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_UBL (PHIVE_RULES_FOUNDATIONS_PARENT_POM, "phive-rules-ubl", EProjectType.JAVA_LIBRARY),
  ...
  PHIVE_RULES_CIUS_DK (PHIVE_RULES_PARENT_POM, "phive-rules-cius-dk", EProjectType.JAVA_LIBRARY),
  ...
  PHIVE_RULES_ERACUN (PHIVE_RULES_PARENT_POM, "phive-rules-eracun", EProjectType.JAVA_LIBRARY),
  ...
  PHIVE_RULES_PEPPOL_PINT (PHIVE_RULES_PARENT_POM, "phive-rules-peppol-pint", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_PEPPOL_TAXDATA (PHIVE_RULES_PARENT_POM, "phive-rules-peppol-taxdata", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_SERBIA (PHIVE_RULES_PARENT_POM, "phive-rules-serbia", EProjectType.JAVA_LIBRARY),
  ...
  PHIVE_RULES_SINGAPORE (PHIVE_RULES_PARENT_POM, "phive-rules-singapore", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_SVEFAKTURA (PHIVE_RULES_PARENT_POM, "phive-rules-svefaktura", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_TURKEY (PHIVE_RULES_PARENT_POM, "phive-rules-turkey", EProjectType.JAVA_LIBRARY),
  ...
  PHIVE_RULES_ZATCA (PHIVE_RULES_PARENT_POM, "phive-rules-zatca", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_ZUGFERD (PHIVE_RULES_PARENT_POM, "phive-rules-zugferd", EProjectType.JAVA_LIBRARY),

  PHIVE_RULES_LEGACY_PARENT_POM (null,
                                 EProjectOwner.PROJECT_OWNER_PHAX,
                                 "phive-rules-legacy-parent-pom",
                                 "phive-rules-legacy",
                                 EProjectType.MAVEN_POM,
                                 EHasPages.FALSE,
                                 EHasWiki.FALSE,
                                 "4.6.1",
                                 EJDK.JDK17),
  PHIVE_RULES_ALL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM, "phive-rules-all-legacy", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_OIOUBL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM, "phive-rules-oioubl-legacy", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_PEPPOL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM, "phive-rules-peppol-legacy", EProjectType.JAVA_LIBRARY),
  ...
  KALTBLUT_VERAPDF (KALTBLUT_PARENT_POM, "kaltblut-verapdf", EProjectType.JAVA_LIBRARY),
  KALTBLUT_CLI (KALTBLUT_PARENT_POM, "kaltblut-cli", EProjectType.JAVA_APPLICATION),
  ...
  PHASE4_PROFILE_EDELIVERY2 (PHASE4_PARENT_POM, "phase4-profile-edelivery2", EProjectType.JAVA_LIBRARY),
  PHASE4_PROFILE_ENTSOG (PHASE4_PARENT_POM, "phase4-profile-entsog", EProjectType.JAVA_LIBRARY),
  PHASE4_PROFILE_EUCTP (PHASE4_PARENT_POM, "phase4-profile-euctp", EProjectType.JAVA_LIBRARY),
  PHASE4_PROFILE_HREDELIVERY (PHASE4_PARENT_POM, "phase4-profile-hredelivery", EProjectType.JAVA_LIBRARY),
  ...
  PHASE4_DBNALLIANCE_CLIENT (PHASE4_PARENT_POM, "phase4-dbnalliance-client", EProjectType.JAVA_LIBRARY),
  PHASE4_DBNALLIANCE_SERVLET (PHASE4_PARENT_POM, "phase4-dbnalliance-servlet", EProjectType.JAVA_LIBRARY),
  PHASE4_DBNALLIANCE_SERVER_WEBAPP (PHASE4_PARENT_POM,
                                    "phase4-dbnalliance-server-webapp",
                                    EProjectType.JAVA_WEB_APPLICATION),
  PHASE4_EDELIVERY2_CLIENT (PHASE4_PARENT_POM, "phase4-edelivery2-client", EProjectType.JAVA_LIBRARY),
  PHASE4_ENTSOG_CLIENT (PHASE4_PARENT_POM, "phase4-entsog-client", EProjectType.JAVA_LIBRARY),
  PHASE4_EUCTP_CLIENT (PHASE4_PARENT_POM, "phase4-euctp-client", EProjectType.JAVA_LIBRARY),
  PHASE4_EUDAMED_CLIENT (PHASE4_PARENT_POM, "phase4-eudamed-client", EProjectType.JAVA_LIBRARY),
  PHASE4_HREDELIVERY_CLIENT (PHASE4_PARENT_POM, "phase4-hredelivery-client", EProjectType.JAVA_LIBRARY),
  PHASE4_HREDELIVERY_SERVLET (PHASE4_PARENT_POM, "phase4-hredelivery-servlet", EProjectType.JAVA_LIBRARY),
  ...
  PHASE4_PEPPOL_STANDALONE (null,
                            ...
                            null,
                            EJDK.JDK17),
  PHASE4_HREDELIVERY_STANDALONE (null,
                                 EProjectOwner.PROJECT_OWNER_PHAX,
                                 "phase4-hredelivery-standalone",
                                 "phase4-hredelivery-standalone",
                                 EProjectType.JAVA_APPLICATION,
                                 EHasPages.FALSE,
                                 EHasWiki.FALSE,
  ...
  PEPPOL_SHARED_UI_PARENT_POM (null,
                               EProjectOwner.PROJECT_OWNER_PHAX,
                               "peppol-shared-ui-parent-pom",
                               "peppol-shared-ui",
                               EProjectType.MAVEN_POM,
                               EHasPages.FALSE,
                               EHasWiki.FALSE,
  ...
  PEPPOL_SHARED_API (PEPPOL_SHARED_UI_PARENT_POM, "peppol-shared-api", EProjectType.JAVA_LIBRARY),
  PEPPOL_SHARED_UI (PEPPOL_SHARED_UI_PARENT_POM, "peppol-shared-ui", EProjectType.JAVA_LIBRARY),
  PEPPOL_SHARED_VALIDATION (PEPPOL_SHARED_UI_PARENT_POM, "peppol-shared-validation", EProjectType.JAVA_LIBRARY),
  PEPPOL_SHARED_AS4 (PEPPOL_SHARED_UI_PARENT_POM, "peppol-shared-as4", EProjectType.JAVA_LIBRARY),
  ...
  PHOSS_DIRECTORY_INDEXER_CONFORMANCE (PHOSS_DIRECTORY_PARENT_POM,
                                       "phoss-directory-indexer-conformance",
                                       EProjectType.JAVA_LIBRARY),
  PHOSS_DIRECTORY_INDEXER_LUCENE (PHOSS_DIRECTORY_PARENT_POM,
                                  "phoss-directory-indexer-lucene",
                                  EProjectType.JAVA_LIBRARY),
  PHOSS_DIRECTORY_INDEXER_OPENSEARCH (PHOSS_DIRECTORY_PARENT_POM,
                                      "phoss-directory-indexer-opensearch",
                                      EProjectType.JAVA_LIBRARY),
  ...
  PHOSS_AP_TESTBACKEND (PHOSS_AP_PARENT_POM, "phoss-ap-testbackend", EProjectType.JAVA_APPLICATION),
  PHOSS_AP_TESTSENDER (PHOSS_AP_PARENT_POM, "phoss-ap-testsender", EProjectType.JAVA_APPLICATION),
  PHOSS_AP_VALIDATION (PHOSS_AP_PARENT_POM, "phoss-ap-validation", EProjectType.JAVA_LIBRARY),
  PHOSS_AP_WEBAPP (PHOSS_AP_PARENT_POM, "phoss-ap-webapp", EProjectType.JAVA_APPLICATION),
  ...
  PH_REDACT_PARENT_POM (null,
                        EProjectOwner.PROJECT_OWNER_PHAX,
                        "ph-redact-parent-pom",
                        "ph-redact",
                        EProjectType.MAVEN_POM,
                        EHasPages.FALSE,
                        EHasWiki.FALSE,
