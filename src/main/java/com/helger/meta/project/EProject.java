...
public enum EProject implements IProject
{
  ...
  PHIVE_RULES_PEPPOL_PINT (PHIVE_RULES_PARENT_POM, "phive-rules-peppol-pint", EProjectType.JAVA_LIBRARY, null),
  PHIVE_RULES_PEPPOL_TAXDATA (PHIVE_RULES_PARENT_POM, "phive-rules-peppol-taxdata", EProjectType.JAVA_LIBRARY, null),
  ...
  PHIVE_RULES_LEGACY_PARENT_POM (null,
                                 ...
                                 "4.6.0",
                                 EJDK.JDK17),
  PHIVE_RULES_ALL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM, "phive-rules-all-legacy", EProjectType.JAVA_LIBRARY, "4.5.7"),
  PHIVE_RULES_OIOUBL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM, "phive-rules-oioubl-legacy", EProjectType.JAVA_LIBRARY),
  PHIVE_RULES_PEPPOL_LEGACY (PHIVE_RULES_LEGACY_PARENT_POM,
