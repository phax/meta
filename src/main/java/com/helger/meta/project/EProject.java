...
public enum EProject implements IProject
{
 ...
 PH_CSSCOMPRESS_MAVEN_PLUGIN (null,
 ...
 PH_MASTERDATA (null, "ph-masterdata", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "4.0.1"),
 ...
 AS2_SERVER (null, "as2-server", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "2.2.1"),

 AS2_PEPPOL_CLIENT (null, "as2-peppol-client", EProjectType.JAVA_APPLICATION, EHasPages.FALSE, EHasWiki.FALSE, null),
 AS2_PEPPOL_SERVLET (null, "as2-peppol-servlet", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "2.1.1"),
 ...
 PEPPOL_TESTFILES (PEPPOL_COMMONS_PARENT_POM,
                   ...
                   EHasWiki.FALSE,
                   PEPPOL_COMMONS_PARENT_POM.getLastPublishedVersionString ()),
 PEPPOL_BDXR (PEPPOL_COMMONS_PARENT_POM,
              "peppol-bdxr",
              EProjectType.JAVA_LIBRARY,
              EHasPages.FALSE,
              EHasWiki.FALSE,
 ...
 PEPPOL_SMP_CLIENT (null, "peppol-smp-client", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "4.1.1"),
 PEPPOL_SML_CLIENT (null, "peppol-sml-client", EProjectType.JAVA_LIBRARY, EHasPages.FALSE, EHasWiki.FALSE, "4.1.1"),
 PEPPOL_VALIDATION_ENGINE (null,
 ...
 PYP_PARENT_POM (null,
                 "peppol-yellow-pages-parent-pom",
                 "peppol-yellow-pages",
                 EProjectType.MAVEN_POM,
                 EHasPages.FALSE,
                 EHasWiki.FALSE,
                 null),
 PYP_API (PYP_PARENT_POM,
          "peppol-yellow-pages-api",
          EProjectType.JAVA_LIBRARY,
          EHasPages.FALSE,
          EHasWiki.FALSE,
          PYP_PARENT_POM.getLastPublishedVersionString ()),
 PYP_INDEXER (PYP_PARENT_POM,
              "peppol-yellow-pages-indexer",
              EProjectType.JAVA_LIBRARY,
              EHasPages.FALSE,
              EHasWiki.FALSE,
              PYP_PARENT_POM.getLastPublishedVersionString ()),
 PYP_PUBLISHER (PYP_PARENT_POM,
                "peppol-yellow-pages-publisher",
                EProjectType.JAVA_WEB_APPLICATION,
                EHasPages.FALSE,
                EHasWiki.FALSE,
                PYP_PARENT_POM.getLastPublishedVersionString ()),
 PYP_CLIENT (PYP_PARENT_POM,
             "peppol-yellow-pages-client",
             EProjectType.JAVA_LIBRARY,
             EHasPages.FALSE,
             EHasWiki.FALSE,
             PYP_PARENT_POM.getLastPublishedVersionString ()),
 ...
 PH_AS4_SERVER (PH_AS4_PARENT_POM,
                "ph-as4-server",
                EProjectType.JAVA_WEB_APPLICATION,
                EHasPages.FALSE,
                EHasWiki.FALSE,
