...
public enum EProject implements IProject
{
  PH_PARENT_POM (null,
                 ...
                 "1.10.3",
                 EJDK.JDK8),
  // Should be deprecated after ph-wsclient 9.1.0
  PH_JAXWS (null,
            IProject.DEFAULT_PROJECT_OWNER,
            "ph-jaxws",
            "ph-jaxws",
  ...
  PH_BC (PH_COMMONS_PARENT_POM, "ph-bc", EProjectType.JAVA_LIBRARY, (String) null),
  ...
  PH_UBLPE (PH_UBL_PARENT_POM, "ph-ublpe", EProjectType.JAVA_LIBRARY, (String) null),
