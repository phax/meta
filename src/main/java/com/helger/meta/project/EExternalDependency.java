...
public enum EExternalDependency
{
  ...
  ASM ("org.ow2.asm", "asm", "9.7", EJDK.JDK8),
  ...
  AWS_S3 ("software.amazon.awssdk", "s3", "2.26.20", EJDK.JDK8),
  ...
  COMMONS_COMPRESS ("org.apache.commons", "commons-compress", "1.26.2", EJDK.JDK8),
  ...
  EASYMOCK ("org.easymock", "easymock", "5.3.0", EJDK.JDK8),

  ECLIPSELINK_ASM ("org.eclipse.persistence", "org.eclipse.persistence.asm", "9.7.0", EJDK.JDK11),
  ECLIPSELINK4_CORE ("org.eclipse.persistence", "org.eclipse.persistence.core", "4.0.3", EJDK.JDK11),
  ...
  ECLIPSE_JDT_CORE_11 ("org.eclipse.jdt", "org.eclipse.jdt.core", "3.38.0", EJDK.JDK11),

  ECLIPSE_CORE_CONTENTTYPE2 ("org.eclipse.platform", "org.eclipse.core.contenttype", "3.9.400", EJDK.JDK11),
  ECLIPSE_CORE_JOBS2 ("org.eclipse.platform", "org.eclipse.core.jobs", "3.15.300", EJDK.JDK11),
  ECLIPSE_CORE_RESOURCES2 ("org.eclipse.platform", "org.eclipse.core.resources", "3.20.200", EJDK.JDK11),
  ECLIPSE_CORE_RUNTIME2 ("org.eclipse.platform", "org.eclipse.core.runtime", "3.31.100", EJDK.JDK11),
  ECLIPSE_EQUINOX_COMMON2 ("org.eclipse.platform", "org.eclipse.equinox.common", "3.19.100", EJDK.JDK11),
  ...
  FLAPDOODLE_4 ("de.flapdoodle.embed", "de.flapdoodle.embed.mongo", "4.16.0", EJDK.JDK8),

  @VersionMaxExcl ("10")
  FLYWAY9("org.flywaydb", "flyway-core", "9.22.3", EJDK.JDK8),
  FLYWAY_MYSQL9 ("org.flywaydb", "flyway-mysql", FLYWAY9),

  FLYWAY10 ("org.flywaydb", "flyway-core", "10.15.2", EJDK.JDK17),
  ...
  FORBIDDEN_APIS ("de.thetaphi", "forbiddenapis", "3.7", EJDK.JDK8),
  ...
  GOOGLE_PROTOBUF3 ("com.google.protobuf", "protobuf-java", "3.25.3", EJDK.JDK8),
  GOOGLE_PROTOBUF4 ("com.google.protobuf", "protobuf-java", "4.27.2", EJDK.JDK8),

  H2 ("com.h2database", "h2", "2.2.224", EJDK.JDK8),

  HAMCREST_LIBRARY ("org.hamcrest", "hamcrest-library", "2.2", EJDK.JDK8),

  HAZELCAST ("com.hazelcast", "hazelcast", "5.4.0", EJDK.JDK8),

  HTTP_CORE5 ("org.apache.httpcomponents.core5", "httpcore5", "5.2.5", EJDK.JDK8),
  HTTP_CLIENT5 ("org.apache.httpcomponents.client5", "httpclient5", "5.3.1", EJDK.JDK8),

  IBM_JCC ("com.ibm.db2", "jcc", "11.5.9.0", EJDK.JDK8),

  @IsBOM
  JACKSON_BOM ("com.fasterxml.jackson", "jackson-bom", "2.17.2", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.26.1", EJDK.JDK8),
  ...
  JEDIS ("redis.clients", "jedis", "5.1.3", EJDK.JDK8),
  ...
  JUNIT5_JUPITER ("org.junit.jupiter", "junit-jupiter", "5.10.3", EJDK.JDK8),
  ...
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.10.3", EJDK.JDK8),
  JUNIT5_PLATFORM_SUREFIRE_PROVIDER ("org.junit.platform", "junit-platform-surefire-provider", "1.3.2", EJDK.JDK8),

  KAFKA_CLIENT ("org.apache.kafka", "kafka-clients", "3.7.1", EJDK.JDK8),

  LITTLEPROXY ("org.littleshoot", "littleproxy", "1.1.2", EJDK.JDK8),

  LOG4J2_CORE ("org.apache.logging.log4j", "log4j-core", "2.23.1", EJDK.JDK8),
  ...
  LUCENE9_CORE ("org.apache.lucene", "lucene-core", "9.11.1", EJDK.JDK8),
  ...
  MYSQL ("com.mysql", "mysql-connector-j", "9.0.0", EJDK.JDK8),
  ...
  OWASP_DEPENDENCY_CHECK ("org.owasp", "dependency-check-maven", "10.0.2", EJDK.JDK8),

  PDFBOX ("org.apache.pdfbox", "pdfbox", "3.0.2", EJDK.JDK8),
  ...
  POI ("org.apache.poi", "poi", "5.3.0", EJDK.JDK8),
  POI_OOXML ("org.apache.poi", "poi-ooxml", POI),
  POI_SCRATCHPAD ("org.apache.poi", "poi-scratchpad", POI),

  POSTGRESQL ("org.postgresql", "postgresql", "42.7.3", EJDK.JDK8),
  ...
  @IsBOM
  SPRING6_FRAMEWORK_BOM ("org.springframework", "spring-framework-bom", "6.1.11", EJDK.JDK11),

  @IsBOM
  SPRING_BOOT3_DEPENDENCIES ("org.springframework.boot", "spring-boot-dependencies", "3.3.1", EJDK.JDK11),
  ...
  VERSIONS_MAVEN_PLUGIN ("org.codehaus.mojo", "versions-maven-plugin", "2.17.0", EJDK.JDK8),
  ...
  // Java 11
  XMLSEC_4 ("org.apache.santuario", "xmlsec", "4.0.2", EJDK.JDK11),
  ...
  PARENT_POM_0 ("com.mycila", "license-maven-plugin", "4.5", EJDK.JDK8),
  ...
  PARENT_POM_6 ("org.apache.maven.plugins", "maven-checkstyle-plugin", "3.4.0", EJDK.JDK8),
  ...
  PARENT_POM_9 ("org.apache.maven.plugins", "maven-dependency-plugin", "3.7.1", EJDK.JDK8),
  ...
  PARENT_POM_19 ("org.apache.maven.plugins", "maven-javadoc-plugin", "3.7.0", EJDK.JDK8),
  PARENT_POM_20 ("org.apache.maven.plugins", "maven-jdeps-plugin", "3.1.2", EJDK.JDK8),
  PARENT_POM_21 ("org.apache.maven.plugins", "maven-jxr-plugin", "3.4.0", EJDK.JDK8),
  PARENT_POM_22 ("org.apache.maven.plugins", "maven-pmd-plugin", "3.23.0", EJDK.JDK8),
  PARENT_POM_23 ("org.apache.maven.plugins", "maven-project-info-reports-plugin", "3.6.1", EJDK.JDK8),
  PARENT_POM_24 ("org.apache.maven.plugins", "maven-rar-plugin", "3.0.0", EJDK.JDK8),
  PARENT_POM_25 ("org.apache.maven.plugins", "maven-release-plugin", "3.1.0", EJDK.JDK8),
  ...
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-surefire-plugin", "3.3.1", EJDK.JDK8),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "3.3.1", EJDK.JDK8),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "3.3.1", EJDK.JDK8),
  ...
  PARENT_POM_37 ("com.github.spotbugs", "spotbugs-maven-plugin", "4.8.6.2", EJDK.JDK8),
  PARENT_POM_38 ("org.codehaus.mojo", "jdepend-maven-plugin", "2.0", EJDK.JDK8),
  PARENT_POM_39 ("org.codehaus.mojo", "taglist-maven-plugin", "3.1.0", EJDK.JDK8);
