...
public enum EExternalDependency
{
  ...
  ANT ("org.apache.ant", "ant", "1.10.13", EJDK.JDK8),
  ...
  COMMONS_NET ("commons-net", "commons-net", "3.9.0", EJDK.JDK8),
  ...
  ECLIPSE_JDT_CORE_11 ("org.eclipse.jdt", "org.eclipse.jdt.core", "3.34.0", EJDK.JDK11),

  ECLIPSE_CORE_CONTENTTYPE ("org.eclipse.platform", "org.eclipse.core.contenttype", "3.7.1000", EJDK.JDK8),
  ECLIPSE_CORE_CONTENTTYPE2 ("org.eclipse.platform", "org.eclipse.core.contenttype", "3.9.0", EJDK.JDK11),
  ECLIPSE_CORE_JOBS ("org.eclipse.platform", "org.eclipse.core.jobs", "3.10.1100", EJDK.JDK8),
  ECLIPSE_CORE_JOBS2 ("org.eclipse.platform", "org.eclipse.core.jobs", "3.14.0", EJDK.JDK11),
  ECLIPSE_CORE_RESOURCES ("org.eclipse.platform", "org.eclipse.core.resources", "3.13.900", EJDK.JDK8),
  ECLIPSE_CORE_RESOURCES2 ("org.eclipse.platform", "org.eclipse.core.resources", "3.19.0", EJDK.JDK11),
  ECLIPSE_CORE_RUNTIME ("org.eclipse.platform", "org.eclipse.core.runtime", "3.13.0", EJDK.JDK8),
  ECLIPSE_CORE_RUNTIME2 ("org.eclipse.platform", "org.eclipse.core.runtime", "3.27.0", EJDK.JDK11),
  ECLIPSE_EQUINOX_COMMON ("org.eclipse.platform", "org.eclipse.equinox.common", "3.8.0", EJDK.JDK8),
  ECLIPSE_EQUINOX_COMMON2 ("org.eclipse.platform", "org.eclipse.equinox.common", "3.18.0", EJDK.JDK11),
  ...
  FLYWAY9 ("org.flywaydb", "flyway-core", "9.20.0", EJDK.JDK8),
  ...
  HAZELCAST ("com.hazelcast", "hazelcast", "5.3.1", EJDK.JDK8),
  ...
  HTTP_CLIENT_FLUENT_HC4 ("org.apache.httpcomponents", "fluent-hc", "4.5.14", EJDK.JDK8),

  HTTP_CORE5 ("org.apache.httpcomponents.core5", "httpcore5", "5.2.2", EJDK.JDK8),
  HTTP_CLIENT5 ("org.apache.httpcomponents.client5", "httpclient5", "5.2.1", EJDK.JDK8),
  ...
  JACOCO ("org.jacoco", "jacoco-maven-plugin", "0.8.10", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.25.4", EJDK.JDK8),
  ...
  @IsBOM
  JAXB4_BOM ("com.sun.xml.bind", "jaxb-bom-ext", "4.0.3", EJDK.JDK11),
  ...
  @IsBOM
  JERSEY3_BOM ("org.glassfish.jersey", "jersey-bom", "3.1.2", EJDK.JDK11),
  ...
  @IsBOM
  JETTY11_BOM ("org.eclipse.jetty", "jetty-bom", "11.0.15", EJDK.JDK11),
  ...
  JUNIT5_JUPITER ("org.junit.jupiter", "junit-jupiter", "5.9.3", EJDK.JDK8),
  ...
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.9.3", EJDK.JDK8),
  JUNIT5_PLATFORM_SUREFIRE_PROVIDER ("org.junit.platform", "junit-platform-surefire-provider", "1.3.2", EJDK.JDK8),

  KAFKA_CLIENT ("org.apache.kafka", "kafka-clients", "3.5.0", EJDK.JDK8),

  LITTLEPROXY ("org.littleshoot", "littleproxy", "1.1.2", EJDK.JDK8),

  LOG4J2_CORE ("org.apache.logging.log4j", "log4j-core", "2.20.0", EJDK.JDK8),
  ...
  LUCENE9_CORE ("org.apache.lucene", "lucene-core", "9.7.0", EJDK.JDK8),
  ...
  MAVEN_PLUGIN_PLUGIN ("org.apache.maven.plugins", "maven-plugin-plugin", "3.9.0", EJDK.JDK8),
  @IsLegacy
  ...
  MONGO_DRIVER_REACTIVESTREAMS ("org.mongodb", "mongodb-driver-reactivestreams", "4.10.1", EJDK.JDK8),
  MONGO_DRIVER_SYNC ("org.mongodb", "mongodb-driver-sync", MONGO_DRIVER_REACTIVESTREAMS),

  MYSQL ("com.mysql", "mysql-connector-j", "8.0.33", EJDK.JDK8),

  @IsBOM
  ORACLE_JDBC ("com.oracle.database.jdbc", "ojdbc-bom", "23.2.0.0", EJDK.JDK8),

  OWASP_DEPENDENCY_CHECK ("org.owasp", "dependency-check-maven", "8.3.1", EJDK.JDK8),

  PDFBOX ("org.apache.pdfbox", "pdfbox", "2.0.29", EJDK.JDK8),
  ...
  POSTGRESQL ("org.postgresql", "postgresql", "42.6.0", EJDK.JDK8),
  ...
  @IsBOM
  SPRING6_FRAMEWORK_BOM ("org.springframework", "spring-framework-bom", "6.0.10", EJDK.JDK11),

  @IsBOM
  @VersionMaxExcl ("3.0.0")
  SPRING_BOOT2_DEPENDENCIES("org.springframework.boot", "spring-boot-dependencies", "2.7.13", EJDK.JDK8),
  ...
  @IsBOM
  SPRING_BOOT3_DEPENDENCIES ("org.springframework.boot", "spring-boot-dependencies", "3.1.1", EJDK.JDK11),
  ...
  VERSIONS_MAVEN_PLUGIN ("org.codehaus.mojo", "versions-maven-plugin", "2.16.0", EJDK.JDK8),
  ...
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-shade-plugin", "3.5.0", EJDK.JDK8),
  ...
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-surefire-plugin", "3.1.2", EJDK.JDK8),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "3.1.2", EJDK.JDK8),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "3.1.2", EJDK.JDK8),
  ...
  PARENT_POM_37 ("com.github.spotbugs", "spotbugs-maven-plugin", "4.7.3.5", EJDK.JDK8),
