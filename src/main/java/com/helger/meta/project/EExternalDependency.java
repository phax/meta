...
public enum EExternalDependency
{
  ...
  ANT ("org.apache.ant", "ant", "1.10.11", EJDK.JDK8),
  ...
  BC_MAIL ("org.bouncycastle", "bcmail-jdk15on", "1.69", EJDK.JDK8),
  ...
  ECLIPSELINK3_ASM ("org.eclipse.persistence", "org.eclipse.persistence.asm", "9.1.1", EJDK.JDK11),
  ...
  FLYWAY ("org.flywaydb", "flyway-core", "7.13.0", EJDK.JDK8),
  ...
  GOOGLE_CLOSURE ("com.google.javascript", "closure-compiler", "v20210808", EJDK.JDK8),
  GOOGLE_PROTOBUF ("com.google.protobuf", "protobuf-java", "3.17.3", EJDK.JDK8),

  @IsLegacy (replacedWith = "2.5.x")
  GROOVY_ALL_24("org.codehaus.groovy", "groovy-all", "2.4.15", EJDK.LEGACY),
  @IsBOM
  GROOVY_ALL ("org.codehaus.groovy", "groovy-all", "3.0.8", EJDK.JDK8),
  ...
  HAZELCAST ("com.hazelcast", "hazelcast", "4.2.1", EJDK.JDK8),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.12.4", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.22.1", EJDK.JDK8),
  ...
  @IsBOM
  JETTY9_BOM ("org.eclipse.jetty", "jetty-bom", "9.4.43.v20210629", EJDK.JDK8),
  ...
  @IsBOM
  JETTY11_BOM ("org.eclipse.jetty", "jetty-bom", "11.0.6", EJDK.JDK11),
  ...
  JUNIT5_JUPITER ("org.junit.jupiter", "junit-jupiter", "5.7.2", EJDK.JDK8),
  ...
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.7.2", EJDK.JDK8),
  JUNIT5_PLATFORM_SUREFIRE_PROVIDER ("org.junit.platform", "junit-platform-surefire-provider", "1.3.2", EJDK.JDK8),

  KAFKA_CLIENT ("org.apache.kafka", "kafka-clients", "2.8.0", EJDK.JDK8),
  ...
  PARENT_POM_23 ("org.apache.maven.plugins", "maven-project-info-reports-plugin", "3.1.2", EJDK.JDK8),
