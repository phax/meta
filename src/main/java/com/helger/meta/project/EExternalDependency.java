...
public enum EExternalDependency
{
  ...
  PARENT_POM_0 ("com.helger", "parent-pom", "1.8.5-SNAPSHOT"),
  PARENT_POM_1 ("org.jacoco", "jacoco-maven-plugin", "0.7.7.201606060606"),
  PARENT_POM_2 ("com.mycila", "license-maven-plugin", "2.11"),
  PARENT_POM_3 ("org.apache.felix", "maven-bundle-plugin", "3.0.1"),
  PARENT_POM_4 ("org.apache.maven.plugins", "maven-acr-plugin", "3.0.0"),
  PARENT_POM_5 ("org.apache.maven.plugins", "maven-antrun-plugin", "1.8"),
  PARENT_POM_6 ("org.apache.maven.plugins", "maven-assembly-plugin", "2.6"),
  PARENT_POM_7 ("org.apache.maven.plugins", "maven-changes-plugin", "2.12"),
  PARENT_POM_8 ("org.apache.maven.plugins", "maven-checkstyle-plugin", "2.17"),
  PARENT_POM_9 ("org.apache.maven.plugins", "maven-clean-plugin", "3.0.0"),
  PARENT_POM_10 ("org.apache.maven.plugins", "maven-compiler-plugin", "3.5.1"),
  PARENT_POM_11 ("org.apache.maven.plugins", "maven-dependency-plugin", "2.10"),
  PARENT_POM_12 ("org.apache.maven.plugins", "maven-deploy-plugin", "2.8.2"),
  PARENT_POM_13 ("org.apache.maven.plugins", "maven-ear-plugin", "2.10.1"),
  PARENT_POM_14 ("org.apache.maven.plugins", "maven-ejb-plugin", "2.5.1"),
  PARENT_POM_15 ("org.apache.maven.plugins", "maven-enforcer-plugin", "1.4.1"),
  PARENT_POM_16 ("org.apache.maven.plugins", "maven-gpg-plugin", "1.6"),
  PARENT_POM_17 ("org.apache.maven.plugins", "maven-idea-plugin", "2.2.1"),
  PARENT_POM_18 ("org.apache.maven.plugins", "maven-install-plugin", "2.5.2"),
  PARENT_POM_19 ("org.apache.maven.plugins", "maven-jar-plugin", "3.0.2"),
  PARENT_POM_20 ("org.apache.maven.plugins", "maven-jarsigner-plugin", "1.4"),
  PARENT_POM_21 ("org.apache.maven.plugins", "maven-javadoc-plugin", "2.10.4"),
  PARENT_POM_22 ("org.apache.maven.plugins", "maven-jdeps-plugin", "3.0.0"),
  PARENT_POM_23 ("org.apache.maven.plugins", "maven-jxr-plugin", "2.5"),
  PARENT_POM_24 ("org.apache.maven.plugins", "maven-plugin-plugin", "3.4"),
  PARENT_POM_25 ("org.apache.maven.plugins", "maven-pmd-plugin", "3.6"),
  PARENT_POM_26 ("org.apache.maven.plugins", "maven-project-info-reports-plugin", "2.9"),
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-rar-plugin", "2.4"),
  PARENT_POM_28 ("org.apache.maven.plugins", "maven-release-plugin", "2.5.3"),
  PARENT_POM_29 ("org.apache.maven.plugins", "maven-resources-plugin", "3.0.1"),
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-shade-plugin", "2.4.3"),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-site-plugin", "3.5.1"),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-source-plugin", "3.0.1"),
  PARENT_POM_33 ("org.apache.maven.plugins", "maven-surefire-plugin", "2.19.1"),
  PARENT_POM_34 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "2.19.1"),
  PARENT_POM_35 ("org.apache.maven.plugins", "maven-failsafe-plugin", "2.19.1"),
  PARENT_POM_36 ("org.apache.maven.plugins", "maven-war-plugin", "2.6"),
  PARENT_POM_37 ("org.codehaus.mojo", "clirr-maven-plugin", "2.7"),
  PARENT_POM_38 ("org.codehaus.mojo", "cobertura-maven-plugin", "2.7"),
  PARENT_POM_39 ("org.codehaus.mojo", "findbugs-maven-plugin", "3.0.3"),
  PARENT_POM_40 ("org.codehaus.mojo", "jdepend-maven-plugin", "2.0"),
  PARENT_POM_41 ("org.codehaus.mojo", "taglist-maven-plugin", "2.4"),
  PARENT_POM_42 ("com.helger.maven", "ph-buildinfo-maven-plugin", "1.3.0"),
  PARENT_POM_43 ("com.helger.maven", "ph-dirindex-maven-plugin", "1.2.1"),
  PARENT_POM_44 ("com.helger.maven", "ph-jscompress-maven-plugin", "2.1.1"),
  PARENT_POM_45 ("com.helger.maven", "ph-csscompress-maven-plugin", "2.0.0"),
  PARENT_POM_46 ("de.thetaphi", "forbiddenapis", "2.2"),
  PARENT_POM_47 ("org.eclipse.m2e", "lifecycle-mapping", "1.0.0"),
  PARENT_POM_48 ("org.umlgraph", "doclet", "5.1");
