...
public enum EExternalDependency
{
  ...
  AWS_S3 ("software.amazon.awssdk", "s3", "2.49.2", EJDK.JDK8),
  ...
  SENTRY ("io.sentry", "sentry", "8.50.1", EJDK.JDK11),
  ...
  PARENT_POM_0 ("com.mycila", "license-maven-plugin", "5.1.1", EJDK.JDK8),
