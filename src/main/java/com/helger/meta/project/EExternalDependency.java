...
public enum EExternalDependency
{
  ...
  ANT ("org.apache.ant", "ant", "1.10.3", EJDK.JDK6),
  ...
  EASYMOCK ("org.easymock", "easymock", "3.6", EJDK.JDK6),

  ECLIPSELINK_CORE ("org.eclipse.persistence", "org.eclipse.persistence.core", "2.7.1", EJDK.JDK7),
  ...
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "3.6.10", EJDK.JDK8),
  ...
  JBIG2_APACHE ("org.apache.pdfbox", "jbig2-imageio", "3.0.1", EJDK.JDK6),
  ...
  KAFKA_CLIENT ("org.apache.kafka", "kafka-clients", "1.1.0", EJDK.JDK8),
  ...
  LUCENE_CORE ("org.apache.lucene", "lucene-core", "7.3.1", EJDK.JDK7),
  ...
  MAVEN_PLUGIN_PLUGIN ("org.apache.maven.plugins", "maven-plugin-plugin", "3.5.2", EJDK.JDK6),
  @IsLegacy
  ...
  SELENIUM ("org.seleniumhq.selenium", "selenium-java", "3.12.0", EJDK.JDK6),
  @IsLegacy
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "2.0.9.Final", EJDK.JDK6),
  ...
  WSS4J ("org.apache.wss4j", "wss4j-ws-security-dom", "2.2.2", EJDK.JDK6),
  ...
  PARENT_POM_1 ("org.apache.felix", "maven-bundle-plugin", "3.5.1", EJDK.JDK6),
  ...
  PARENT_POM_12 ("org.apache.maven.plugins", "maven-ejb-plugin", "3.0.1", EJDK.JDK6),
  ...
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-shade-plugin", "3.1.1", EJDK.JDK6),
  PARENT_POM_28 ("org.apache.maven.plugins", "maven-site-plugin", "3.7.1", EJDK.JDK6),
  PARENT_POM_29 ("org.apache.maven.plugins", "maven-source-plugin", "3.0.1", EJDK.JDK6),
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-surefire-plugin", "2.22.0", EJDK.JDK6),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "2.22.0", EJDK.JDK6),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "2.22.0", EJDK.JDK6),
