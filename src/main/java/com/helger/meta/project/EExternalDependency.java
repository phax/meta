...
public enum EExternalDependency
{
  ...
  FELIX ("org.apache.felix", "org.apache.felix.framework", "5.6.1", EJDK.JDK6),
  ...
  FLAPDOODLE ("de.flapdoodle.embed", "de.flapdoodle.embed.mongo", "1.50.5", EJDK.JDK6),
  FLUENT_HC ("org.apache.httpcomponents", "fluent-hc", "4.5.2", EJDK.JDK6),
  FOP ("org.apache.xmlgraphics", "fop", "2.1", EJDK.JDK6),
  FOP_HYPH ("net.sf.offo", "fop-hyph", "2.0", EJDK.JDK6),
  FORBIDDEN_APIS ("de.thetaphi", "forbiddenapis", "2.2", EJDK.JDK6),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.8.6", EJDK.JDK6),
  JACKSON_DATABIND ("com.fasterxml.jackson.core", "jackson-databind", JACKSON_CORE),
  JACOCO ("org.jacoco", "jacoco-maven-plugin", "0.7.8", EJDK.JDK6),
  JAVA_PARSER_24 ("com.github.javaparser", "javaparser-core", "2.4.0", EJDK.JDK6),
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "3.0.1", EJDK.JDK8),
  JAVAX_EL ("org.glassfish", "javax.el", "3.0.0", EJDK.JDK6),
  JAVAX_MAIL ("com.sun.mail", "javax.mail", "1.5.6", EJDK.JDK6),
  ...
  JAXB2_PLUGIN ("org.jvnet.jaxb2.maven2", "maven-jaxb2-plugin", "0.13.1", EJDK.JDK6),
  ...
  JEROMQ ("org.zeromq", "jeromq", "0.3.6", EJDK.JDK6),
  ...
  JETTY_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.4.1.v20170120", EJDK.JDK8),
  ...
  JODA_TIME ("joda-time", "joda-time", "2.9.7", EJDK.JDK6),
  ...
  LUCENE_CORE ("org.apache.lucene", "lucene-core", "6.4.0", EJDK.JDK7),
  ...
  MONGO_DB ("org.mongodb", "mongodb-driver", "3.4.1", EJDK.JDK6),
  MYSQL ("mysql", "mysql-connector-java", "6.0.5", EJDK.JDK6),
  PDFBOX ("org.apache.pdfbox", "pdfbox", "2.0.4", EJDK.JDK6),
  PDFBOX_EXAMPLES ("org.apache.pdfbox", "pdfbox-examples", PDFBOX),
  POI ("org.apache.poi", "poi", "3.15", EJDK.JDK6),
  POI_OOXML ("org.apache.poi", "poi-ooxml", POI),
  POI_SCRATCHPAD ("org.apache.poi", "poi-scratchpad", POI),
  QUARTZ ("org.quartz-scheduler", "quartz", "2.2.3", EJDK.JDK6),
  RHINO ("org.mozilla", "rhino", "1.7.7.1", EJDK.JDK6),
  RXJAVA ("io.reactivex", "rxjava", "1.2.5", EJDK.JDK6),
  SAXON ("net.sf.saxon", "Saxon-HE", "9.7.0-14", EJDK.JDK6),
  SELENIUM ("org.seleniumhq.selenium", "selenium-java", "3.0.1", EJDK.JDK6),
  ...
  SLF4J_API ("org.slf4j", "slf4j-api", "1.7.22", EJDK.JDK6),
  SLF4J_SIMPLE ("org.slf4j", "slf4j-simple", SLF4J_API),
  SLF4J_LOG4J12 ("org.slf4j", "slf4j-log4j12", SLF4J_API),
  SPOCK_CORE ("org.spockframework", "spock-core", "1.0-groovy-2.4", EJDK.JDK6),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "1.4.8.Final", EJDK.JDK6),
  ...
  XMLSEC ("org.apache.santuario", "xmlsec", "2.0.8", EJDK.JDK6),
  ...
  PARENT_POM_1 ("org.apache.felix", "maven-bundle-plugin", "3.2.0", EJDK.JDK6),
  ...
  PARENT_POM_4 ("org.apache.maven.plugins", "maven-assembly-plugin", "3.0.0", EJDK.JDK6),
  ...
  PARENT_POM_22 ("org.apache.maven.plugins", "maven-pmd-plugin", "3.7", EJDK.JDK6),
  ...
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-shade-plugin", "2.4.3", EJDK.JDK6),
  ...
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-surefire-plugin", "2.19.1", EJDK.JDK6),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "2.19.1", EJDK.JDK6),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "2.19.1", EJDK.JDK6),
  PARENT_POM_33 ("org.apache.maven.plugins", "maven-war-plugin", "3.0.0", EJDK.JDK6),
  ...
  PARENT_POM_36 ("org.codehaus.mojo", "findbugs-maven-plugin", "3.0.4", EJDK.JDK6),
