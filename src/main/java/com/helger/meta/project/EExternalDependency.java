...
public enum EExternalDependency
{
  ...
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "2.5.1"),
  ...
  JETTY_93_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.3.10.v20160621", EJDK.JDK8),
  ...
  MYSQL ("mysql", "mysql-connector-java", "6.0.3"),
