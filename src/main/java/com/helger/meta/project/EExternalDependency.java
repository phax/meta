...
public enum EExternalDependency
{
  ...
  AWS_S3 ("software.amazon.awssdk", "s3", "2.41.4", EJDK.JDK8),
  ...
  ECLIPSE_JDT_CORE_11 ("org.eclipse.jdt", "org.eclipse.jdt.core", "3.44.0", EJDK.JDK11),
  ...
  ECLIPSE_CORE_RESOURCES2 ("org.eclipse.platform", "org.eclipse.core.resources", "3.23.100", EJDK.JDK11),
  ECLIPSE_CORE_RUNTIME2 ("org.eclipse.platform", "org.eclipse.core.runtime", "3.34.100", EJDK.JDK11),
  ...
  FLAPDOODLE_MONGO ("de.flapdoodle.embed", "de.flapdoodle.embed.mongo", "4.22.0", EJDK.JDK8),

  FLYWAY11 ("org.flywaydb", "flyway-core", "11.20.1", EJDK.JDK17),
  ...
  GOOGLE_CLOSURE_21 ("com.google.javascript", "closure-compiler", "v20260107", EJDK.JDK21),

  GOOGLE_PROTOBUF ("com.google.protobuf", "protobuf-java", "4.33.2", EJDK.JDK8),
  ...
  HTTP_CORE5 ("org.apache.httpcomponents.core5", "httpcore5", "5.4", EJDK.JDK8),
  HTTP_CLIENT5 ("org.apache.httpcomponents.client5", "httpclient5", "5.6", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.27.1", EJDK.JDK8),
  ...
  JEDIS ("redis.clients", "jedis", "7.2.0", EJDK.JDK8),
  ...
  @IsBOM
  JETTY12_BOM ("org.eclipse.jetty", "jetty-bom", "12.1.5", EJDK.JDK17),
  ...
  LUCENE10_CORE ("org.apache.lucene", "lucene-core", "10.3.2", EJDK.JDK21),
  ...
  SCHXSLT2 ("name.dmaus.schxslt", "schxslt2", "1.7.2", EJDK.JDK8),
  ...
  // JakartaEE 11
  @IsBOM
  SPRING7_FRAMEWORK_BOM ("org.springframework", "spring-framework-bom", "7.0.2", EJDK.JDK17),

  @IsBOM
  SPRING_BOOT4_DEPENDENCIES ("org.springframework.boot", "spring-boot-dependencies", "4.0.1", EJDK.JDK11),
  ...
  PARENT_POM_17 ("org.apache.maven.plugins", "maven-jar-plugin", "3.5.0", EJDK.JDK8),
  PARENT_POM_18 ("org.apache.maven.plugins", "maven-jarsigner-plugin", "3.1.0", EJDK.JDK8),
  PARENT_POM_19 ("org.apache.maven.plugins", "maven-javadoc-plugin", "3.12.0", EJDK.JDK8),
  PARENT_POM_20 ("org.apache.maven.plugins", "maven-jdeps-plugin", "3.2.0", EJDK.JDK8),
  ...
  PARENT_POM_24 ("org.apache.maven.plugins", "maven-rar-plugin", "3.1.0", EJDK.JDK8),
  PARENT_POM_25 ("org.apache.maven.plugins", "maven-release-plugin", "3.3.1", EJDK.JDK8),
  PARENT_POM_26 ("org.apache.maven.plugins", "maven-resources-plugin", "3.4.0", EJDK.JDK8),
  ...
  OWASP_DEPENDENCY_CHECK ("org.owasp", "dependency-check-maven", "12.2.0", EJDK.JDK8),
