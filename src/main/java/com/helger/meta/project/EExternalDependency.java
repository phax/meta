...
public enum EExternalDependency
{
  ...
  ECLIPSE_JDT_CORE_11 ("org.eclipse.jdt", "org.eclipse.jdt.core", "3.37.0", EJDK.JDK11),

  ECLIPSE_CORE_CONTENTTYPE2 ("org.eclipse.platform", "org.eclipse.core.contenttype", "3.9.300", EJDK.JDK11),
  ECLIPSE_CORE_JOBS2 ("org.eclipse.platform", "org.eclipse.core.jobs", "3.15.200", EJDK.JDK11),
  ECLIPSE_CORE_RESOURCES2 ("org.eclipse.platform", "org.eclipse.core.resources", "3.20.100", EJDK.JDK11),
  ECLIPSE_CORE_RUNTIME2 ("org.eclipse.platform", "org.eclipse.core.runtime", "3.31.0", EJDK.JDK11),
  ECLIPSE_EQUINOX_COMMON2 ("org.eclipse.platform", "org.eclipse.equinox.common", "3.19.0", EJDK.JDK11),
  ...
  FLAPDOODLE_4 ("de.flapdoodle.embed", "de.flapdoodle.embed.mongo", "4.13.1", EJDK.JDK8),

  @VersionMaxExcl ("10")
  FLYWAY9("org.flywaydb", "flyway-core", "9.22.3", EJDK.JDK8),
  FLYWAY_MYSQL9 ("org.flywaydb", "flyway-mysql", FLYWAY9),

  FLYWAY10 ("org.flywaydb", "flyway-core", "10.13.0", EJDK.JDK17),
  ...
  GOOGLE_PROTOBUF4 ("com.google.protobuf", "protobuf-java", "4.27.0", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.25.10", EJDK.JDK8),
  ...
  JAXB4_MAVEN_PLUGIN ("org.jvnet.jaxb", "jaxb-maven-plugin", "4.0.6", EJDK.JDK8),
  ...
  @IsBOM
  @VersionMaxExcl ("12")
  JETTY11_BOM("org.eclipse.jetty", "jetty-bom", "11.0.20", EJDK.JDK11),
  ...
  @IsBOM
  JETTY12_BOM ("org.eclipse.jetty", "jetty-bom", "12.0.9", EJDK.JDK17),
  ...
  JJWT_IMPL ("io.jsonwebtoken", "jjwt-impl", "0.12.5", EJDK.JDK8),
  ...
  JUNIT5_JUPITER ("org.junit.jupiter", "junit-jupiter", "5.10.2", EJDK.JDK8),
  ...
  LUCENE9_CORE ("org.apache.lucene", "lucene-core", "9.10.0", EJDK.JDK8),
  ...
  OWASP_DEPENDENCY_CHECK ("org.owasp", "dependency-check-maven", "9.2.0", EJDK.JDK8),
  ...
  @IsBOM
  SPRING6_FRAMEWORK_BOM ("org.springframework", "spring-framework-bom", "6.1.8", EJDK.JDK11),

  @IsBOM
  SPRING_BOOT3_DEPENDENCIES ("org.springframework.boot", "spring-boot-dependencies", "3.3.0", EJDK.JDK11),
  ...
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "3.2.5", EJDK.JDK8),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "3.2.5", EJDK.JDK8),
