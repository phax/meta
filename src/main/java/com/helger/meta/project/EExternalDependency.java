...
public enum EExternalDependency
{
  ...
  CLOSURE ("com.google.javascript", "closure-compiler", "v20170218", EJDK.JDK8),
  ...
  GROOVY ("org.codehaus.groovy", "groovy-all", "2.4.9", EJDK.JDK6),
  H2 ("com.h2database", "h2", "1.4.193", EJDK.JDK6),
  HAMCREST_LIBRARY ("org.hamcrest", "hamcrest-library", "1.3", EJDK.JDK6),
  HAZELCAST ("com.hazelcast", "hazelcast", "3.8", EJDK.JDK6),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.8.7", EJDK.JDK6),
  ...
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "3.1.0", EJDK.JDK8),
  ...
  JETTY_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.4.2.v20170220", EJDK.JDK8),
  ...
  LOG4J2_CORE ("org.apache.logging.log4j", "log4j-core", "2.8.1", EJDK.JDK7),
  ...
  SELENIUM ("org.seleniumhq.selenium", "selenium-java", "3.2.0", EJDK.JDK6),
  ...
  SLF4J_API ("org.slf4j", "slf4j-api", "1.7.24", EJDK.JDK6),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "1.4.11.Final", EJDK.JDK6),
