...
public enum EExternalDependency
{
  ...
  ASM ("org.ow2.asm", "asm", "9.0", EJDK.JDK8),
  ...
  COMMONS_NET ("commons-net", "commons-net", "3.7", EJDK.JDK8),
  COMMONS_POOL2 ("org.apache.commons", "commons-pool2", "2.8.1", EJDK.JDK8),
  ...
  FLYWAY ("org.flywaydb", "flyway-core", "6.5.7", EJDK.JDK8),
  ...
  GMAVEN_PLUS ("org.codehaus.gmavenplus", "gmavenplus-plugin", "1.10.1", EJDK.JDK8),

  GOOGLE_CLOSURE ("com.google.javascript", "closure-compiler", "v20200920", EJDK.JDK8),
  ...
  @IsBOM
  GROOVY_ALL ("org.codehaus.groovy", "groovy-all", "3.0.5", EJDK.JDK8),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.11.2", EJDK.JDK8),
  ...
  @IsBOM
  JETTY_BOM ("org.eclipse.jetty", "jetty-bom", "9.4.31.v20200723", EJDK.JDK8),
  ...
  JUNIT5_JUPITER ("org.junit.jupiter", "junit-jupiter", "5.7.0", EJDK.JDK8),
  ...
  MONGO_DRIVER_REACTIVESTREAMS ("org.mongodb", "mongodb-driver-reactivestreams", "4.1.0", EJDK.JDK8),
  MONGO_DRIVER_SYNC ("org.mongodb", "mongodb-driver-sync", "4.1.0", EJDK.JDK8),

  MYSQL ("mysql", "mysql-connector-java", "8.0.21", EJDK.JDK8),

  OWASP_DEPENDENCY_CHECK ("org.owasp", "dependency-check-maven", "6.0.1", EJDK.JDK8),
  ...
  @IsBOM
  SPRING_BOOT_DEPENDENCIES ("org.springframework.boot", "spring-boot-dependencies", "2.3.4.RELEASE", EJDK.JDK8),
  ...
  TYPESAFE_CONFIG ("com.typesafe", "config", "1.4.0", EJDK.JDK8),
  UNDERTOW ("io.undertow", "undertow-servlet", "2.2.0.Final", EJDK.JDK8),
