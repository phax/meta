...
public enum EExternalDependency
{
  ...
  JETTY_92_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.2.15.v20160210", EJDK.JDK7),
  ...
  JODA_TIME ("joda-time", "joda-time", "2.9.2"),
  ...
  SAXON ("net.sf.saxon", "Saxon-HE", "9.7.0-3"),
