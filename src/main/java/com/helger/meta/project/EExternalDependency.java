...
public enum EExternalDependency
{
  ...
  CLOSURE ("com.google.javascript", "closure-compiler", "v20190301", EJDK.JDK8),
  ...
  COMMONS_COLLECTIONS_4 ("org.apache.commons", "commons-collections4", "4.3", EJDK.JDK8),
  COMMONS_DBCP2 ("org.apache.commons", "commons-dbcp2", "2.6.0", EJDK.JDK8),
  COMMONS_EXEC ("org.apache.commons", "commons-exec", "1.3", EJDK.JDK8),
  COMMONS_NET ("commons-net", "commons-net", "3.6", EJDK.JDK8),
  COMMONS_POOL2 ("org.apache.commons", "commons-pool2", "2.6.1", EJDK.JDK8),
  ...
  @IsBOM
  GROOVY_ALL ("org.codehaus.groovy", "groovy-all", "2.5.6", EJDK.JDK8),
  ...
  HAZELCAST ("com.hazelcast", "hazelcast", "3.11.2", EJDK.JDK8),
  HTTP_CORE ("org.apache.httpcomponents", "httpcore", "4.4.11", EJDK.JDK8),
  HTTP_CLIENT ("org.apache.httpcomponents", "httpclient", "4.5.7", EJDK.JDK8),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.9.8", EJDK.JDK8),
  ...
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "3.13.3", EJDK.JDK8),
  ...
  JEROMQ ("org.zeromq", "jeromq", "0.5.0", EJDK.JDK8),
  ...
  @IsBOM
  JETTY_BOM ("org.eclipse.jetty", "jetty-bom", "9.4.15.v20190215", EJDK.JDK8),
  ...
  JUNIT5_JUPITER_API ("org.junit.jupiter", "junit-jupiter-api", "5.4.0", EJDK.JDK8),
  JUNIT5_JUPITER_ENGINE ("org.junit.jupiter", "junit-jupiter-engine", JUNIT5_JUPITER_API),
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.4.0", EJDK.JDK8),
  JUNIT5_PLATFORM_SUREFIRE_PROVIDER ("org.junit.platform", "junit-platform-surefire-provider", "1.3.2", EJDK.JDK8),
  JUNIT5_VINTAGE_ENGINE ("org.junit.vintage", "junit-vintage-engine", "5.4.0", EJDK.JDK8),
  ...
  LUCENE_CORE ("org.apache.lucene", "lucene-core", "8.0.0", EJDK.JDK8),
  ...
  MONGO_DB ("org.mongodb", "mongodb-driver", "3.10.1", EJDK.JDK8),
  MYSQL ("mysql", "mysql-connector-java", "8.0.15", EJDK.JDK8),
  PDFBOX ("org.apache.pdfbox", "pdfbox", "2.0.14", EJDK.JDK8),
  ...
  SLF4J_API ("org.slf4j", "slf4j-api", "1.7.26", EJDK.JDK8),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "2.0.19.Final", EJDK.JDK8),
  ...
  PARENT_POM_17 ("org.apache.maven.plugins", "maven-jar-plugin", "3.1.1", EJDK.JDK8),
