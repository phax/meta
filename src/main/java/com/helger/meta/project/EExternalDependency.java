...
public enum EExternalDependency
{
  ...
  CLOSURE ("com.google.javascript", "closure-compiler", "v20191111", EJDK.JDK8),
  ...
  EASYMOCK ("org.easymock", "easymock", "4.1", EJDK.JDK8),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.10.1", EJDK.JDK8),
  ...
  JAVA_PARSER_CORE ("com.github.javaparser", "javaparser-core", "3.15.5", EJDK.JDK8),
  ...
  JDT_CORE ("org.eclipse.jdt", "org.eclipse.jdt.core", "3.19.0", EJDK.JDK8),
  ...
  // JDK 1.8 since 2.26
  @IsBOM
  JERSEY2_BOM ("org.glassfish.jersey", "jersey-bom", "2.29.1", EJDK.JDK8),
  ...
  @IsBOM
  JETTY_BOM ("org.eclipse.jetty", "jetty-bom", "9.4.24.v20191120", EJDK.JDK8),
  ...
  JUNIT5_JUPITER_API ("org.junit.jupiter", "junit-jupiter-api", "5.5.2", EJDK.JDK8),
  JUNIT5_JUPITER_ENGINE ("org.junit.jupiter", "junit-jupiter-engine", JUNIT5_JUPITER_API),
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.5.2", EJDK.JDK8),
  ...
  LUCENE8_CORE ("org.apache.lucene", "lucene-core", "8.3.0", EJDK.JDK9),
  ...
  SLF4J_API ("org.slf4j", "slf4j-api", "1.7.29", EJDK.JDK8),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "2.0.28.Final", EJDK.JDK8),
  ...
  PARENT_POM_11 ("org.apache.maven.plugins", "maven-ear-plugin", "3.0.2", EJDK.JDK8),
  ...
  PARENT_POM_28 ("org.apache.maven.plugins", "maven-site-plugin", "3.8.2", EJDK.JDK8),
  PARENT_POM_29 ("org.apache.maven.plugins", "maven-source-plugin", "3.2.0", EJDK.JDK8),
  ...
  PARENT_POM_33 ("org.apache.maven.plugins", "maven-war-plugin", "3.2.3", EJDK.JDK8),
  ...
  PARENT_POM_36a ("com.github.spotbugs", "spotbugs-maven-plugin", "3.1.12.2", EJDK.JDK8),
