...
public enum EExternalDependency
{
  ...
  CLOSURE ("com.google.javascript", "closure-compiler", "v20180805", EJDK.JDK8),
  ...
  EASYMOCK ("org.easymock", "easymock", "3.6", EJDK.JDK8),
  ...
  HAZELCAST ("com.hazelcast", "hazelcast", "3.10.4", EJDK.JDK8),
  ...
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.9.6", EJDK.JDK8),
  ...
  JACOCO ("org.jacoco", "jacoco-maven-plugin", "0.8.1", EJDK.JDK8),
  JAVA_PARSER ("com.github.javaparser", "javaparser-core", "3.6.18", EJDK.JDK8),
  JAVACC ("net.java.dev.javacc", "javacc", "7.0.3", EJDK.JDK8),
  JAVAX_ACTIVATION ("javax.activation", "activation", "1.1.1", EJDK.JDK8),
  JAVAX_EL ("org.glassfish", "javax.el", "3.0.0", EJDK.JDK8),
  JAVAX_MAIL ("com.sun.mail", "javax.mail", "1.6.1", EJDK.JDK8),
  ...
  JBIG2_APACHE ("org.apache.pdfbox", "jbig2-imageio", "3.0.1", EJDK.JDK8),
  ...
  JUNIT5_JUPITER_API ("org.junit.jupiter", "junit-jupiter-api", "5.2.0", EJDK.JDK8),
  JUNIT5_JUPITER_ENGINE ("org.junit.jupiter", "junit-jupiter-engine", JUNIT5_JUPITER_API),
  JUNIT5_PLATFORM_LAUNCHER ("org.junit.platform", "junit-platform-launcher", "1.2.0", EJDK.JDK8),
  ...
  LUCENE_CORE ("org.apache.lucene", "lucene-core", "7.4.0", EJDK.JDK8),
  ...
  SPOCK_CORE ("org.spockframework", "spock-core", "1.2-RC1-groovy-2.5", EJDK.JDK8),
  STAX_EX ("org.jvnet.staxex", "stax-ex", "1.7.8", EJDK.JDK8),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "2.0.13.Final", EJDK.JDK8),
  VALIDATION_API ("javax.validation", "validation-api", "2.0.1.Final", EJDK.JDK8),
  VERSIONS_MAVEN_PLUGIN ("org.codehaus.mojo", "versions-maven-plugin", "2.5", EJDK.JDK8),
  WSS4J ("org.apache.wss4j", "wss4j-ws-security-dom", "2.2.2", EJDK.JDK8),
  XMLBEANS ("org.apache.xmlbeans", "xmlbeans", "3.0.0", EJDK.JDK8),
  ...
  PARENT_POM_1 ("org.apache.felix", "maven-bundle-plugin", "3.5.1", EJDK.JDK8),
  ...
  PARENT_POM_21 ("org.apache.maven.plugins", "maven-jxr-plugin", "2.5", EJDK.JDK8),
  PARENT_POM_22 ("org.apache.maven.plugins", "maven-pmd-plugin", "3.10.0", EJDK.JDK8),
  ...
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-shade-plugin", "3.1.1", EJDK.JDK8),
  ...
  PARENT_POM_30 ("org.apache.maven.plugins", "maven-surefire-plugin", "2.22.0", EJDK.JDK8),
  PARENT_POM_31 ("org.apache.maven.plugins", "maven-surefire-report-plugin", "2.22.0", EJDK.JDK8),
  PARENT_POM_32 ("org.apache.maven.plugins", "maven-failsafe-plugin", "2.22.0", EJDK.JDK8),
