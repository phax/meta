...
public enum EExternalDependency
{
  ...
  ANT ("org.apache.ant", "ant", "1.10.16", EJDK.JDK8),
  ...
  AWS_S3 ("software.amazon.awssdk", "s3", "2.42.30", EJDK.JDK8),
  ...
  GOOGLE_CLOSURE_21 ("com.google.javascript", "closure-compiler", "v20260406", EJDK.JDK21),
  ...
  HTTP_CORE5 ("org.apache.httpcomponents.core5", "httpcore5", "5.4.2", EJDK.JDK8),
  HTTP_CLIENT5 ("org.apache.httpcomponents.client5", "httpclient5", "5.6", EJDK.JDK8),

  IBM_JCC ("com.ibm.db2", "jcc", "12.1.4.0", EJDK.JDK8),

  @IsBOM
  JACKSON2_BOM ("com.fasterxml.jackson", "jackson-bom", "2.21.2", EJDK.JDK8),
  ...
  JEDIS ("redis.clients", "jedis", "7.4.1", EJDK.JDK8),
  ...
  POSTGRESQL ("org.postgresql", "postgresql", "42.7.10", EJDK.JDK8),
  ...
  SCHXSLT2 ("name.dmaus.schxslt", "schxslt2", "1.10.1", EJDK.JDK8),

  SENTRY ("io.sentry", "sentry", "8.37.1", EJDK.JDK11),
  ...
  PARENT_POM_1_V6 ("org.apache.felix", "maven-bundle-plugin", "6.0.2", EJDK.JDK17),
  ...
  PARENT_POM_26 ("org.apache.maven.plugins", "maven-resources-plugin", "3.5.0", EJDK.JDK8),
  PARENT_POM_27 ("org.apache.maven.plugins", "maven-shade-plugin", "3.6.2", EJDK.JDK8),
