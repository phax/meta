...
public enum EExternalDependency
{
  ...
  CLOSURE ("com.google.javascript", "closure-compiler", "v20160911"),
  ...
  HYSTRIX_CORE ("com.netflix.hystrix", "hystrix-core", "1.5.5"),
  HYSTRIX_METRICS_EVENT_STREAM ("com.netflix.hystrix", "hystrix-metrics-event-stream", HYSTRIX_CORE),
  JACKSON_CORE ("com.fasterxml.jackson.core", "jackson-core", "2.8.3"),
  ...
  JETTY_92_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.2.18.v20160721", EJDK.JDK7),
  ...
  JETTY_93_WEBAPP ("org.eclipse.jetty", "jetty-webapp", "9.3.12.v20160915", EJDK.JDK8),
  ...
  MYSQL ("mysql", "mysql-connector-java", "6.0.4"),
  ...
  UNDERTOW ("io.undertow", "undertow-servlet", "1.4.3.Final"),
