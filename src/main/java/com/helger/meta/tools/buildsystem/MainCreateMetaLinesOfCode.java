...
public final class MainCreateMetaLinesOfCode extends AbstractProjectMain
{
  private enum EFileType
  {
    ...
    GIT ("git", true, new CommonsTreeSet <> ("gitignore", "gitkeep")),
    ...
    PERL ("Perl", true, new CommonsTreeSet <> ("pl")),
    ...
    CERTIFICATE_RELATED ("Certificate related", false, new CommonsTreeSet <> ("crl")),
    KEYSTORE ("Keystore",
              false,
