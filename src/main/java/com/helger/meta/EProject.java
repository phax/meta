...
public enum EProject
{
  ...
  PH_BOOTSTRAP3 ("ph-bootstrap3", EProjectType.JAVA_LIBRARY, false, false, "1.6.1"),
  ...
  PH_COMMONS ("ph-commons", EProjectType.JAVA_LIBRARY, false, false, "5.1.0"),
  ...
  PH_DB_JPA ("ph-db-jpa", EProjectType.JAVA_LIBRARY, false, false, "3.2.1"),
  ...
  PH_HTML ("ph-html", EProjectType.JAVA_LIBRARY, false, false, "4.4.3"),
  ...
  PH_MASTERDATA ("ph-masterdata", EProjectType.JAVA_LIBRARY, false, false, "3.6.1"),
  ...
  PH_PDF_LAYOUT ("ph-pdf-layout", EProjectType.JAVA_LIBRARY, false, false, "1.3.1"),
  PH_POI ("ph-poi", EProjectType.JAVA_LIBRARY, false, false, "2.9.0"),
  ...
  PH_SCHEDULE ("ph-schedule", EProjectType.JAVA_LIBRARY, false, false, "1.6.2"),
  PH_SCHEMATRON ("ph-schematron", EProjectType.JAVA_LIBRARY, true, false, "2.8.3"),
  PH_SCHEMATRON_TESTFILES ("ph-schematron-testfiles", EProjectType.JAVA_LIBRARY, false, false, "1.1.0"),
  PH_SCHEMATRON_VALIDATOR ("ph-schematron-validator", EProjectType.JAVA_LIBRARY, false, false, "2.8.0"),
  PH_SCOPES ("ph-scopes", EProjectType.JAVA_LIBRARY, false, false, "6.5.0"),
  PH_SETTINGS ("ph-settings", EProjectType.JAVA_LIBRARY, false, false, "1.1.0"),
  ...
  PH_WEB ("ph-web", EProjectType.JAVA_LIBRARY, false, false, "6.0.1"),
  PH_WEBAPP_DEMO ("ph-webapp-demo", EProjectType.JAVA_WEB_APPLICATION, false, false, null),
  PH_WEBBASICS ("ph-webbasics", EProjectType.JAVA_LIBRARY, false, false, "3.4.1"),
  PH_WEBCTRLS ("ph-webctrls", EProjectType.JAVA_LIBRARY, false, false, "2.4.1"),
  PH_WEBSCOPES ("ph-webscopes", EProjectType.JAVA_LIBRARY, false, false, "6.6.0"),
