...
public enum EProject
{
  ...
  PH_DB_JPA ("ph-db-jpa", EProjectType.JAVA_LIBRARY, false, false, "3.2.0"),
  ...
  PH_HTML ("ph-html", EProjectType.JAVA_LIBRARY, false, false, "4.4.2"),
  ...
  PH_MASTERDATA ("ph-masterdata", EProjectType.JAVA_LIBRARY, false, false, "3.6.0"),
  ...
  PH_SCHEDULE ("ph-schedule", EProjectType.JAVA_LIBRARY, false, false, "1.6.1"),
  ...
  PH_SCOPES ("ph-scopes", EProjectType.JAVA_LIBRARY, false, false, "6.4.0"),
