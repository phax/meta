...
public enum EProject
{
  ...
  AS2_PEPPOL_SERVER ("as2-peppol-server", EProjectType.JAVA_WEB_APPLICATION, false, false, null),
  ...
  PH_BOOTSTRAP3 ("ph-bootstrap3", EProjectType.JAVA_LIBRARY, false, false, "1.7.1"),
  ...
  PH_COMMONS ("ph-commons", EProjectType.JAVA_LIBRARY, false, false, "5.2.0"),
  PH_CSS ("ph-css", EProjectType.JAVA_LIBRARY, false, false, "3.8.2"),
  PH_CSSCOMPRESS_MAVEN_PLUGIN ("ph-csscompress-maven-plugin", EProjectType.MAVEN_PLUGIN, false, false, "1.3.1"),
  PH_DATETIME ("ph-datetime", EProjectType.JAVA_LIBRARY, false, false, "3.2.1"),
  ...
  PH_DB_JPA ("ph-db-jpa", EProjectType.JAVA_LIBRARY, false, false, "3.2.2"),
  PH_DIRINDEX_MAVEN_PLUGIN ("ph-dirindex-maven-plugin", EProjectType.MAVEN_PLUGIN, false, false, "1.1.0"),
  PH_EBINTERFACE ("ph-ebinterface", EProjectType.JAVA_LIBRARY, false, true, "3.1.0"),
  PH_FONTS ("ph-fonts", EProjectType.JAVA_LIBRARY, false, false, "1.1.0"),
  PH_GENERICODE ("ph-genericode", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_HTML ("ph-html", EProjectType.JAVA_LIBRARY, false, false, "4.5.0"),
  PH_JAVACC_MAVEN_PLUGIN ("ph-javacc-maven-plugin", EProjectType.MAVEN_PLUGIN, false, false, "2.8.0"),
  PH_JAXB22_PLUGIN ("ph-jaxb22-plugin", EProjectType.JAXB_PLUGIN, false, false, "2.2.7"),
  ...
  PH_PDF_LAYOUT ("ph-pdf-layout", EProjectType.JAVA_LIBRARY, false, false, "1.3.2"),
  PH_POI ("ph-poi", EProjectType.JAVA_LIBRARY, false, false, "2.9.1"),
  PH_SBDH ("ph-sbdh", EProjectType.JAVA_LIBRARY, false, false, "1.1.0"),
  PH_SCH2XSLT_MAVEN_PLUGIN ("ph-sch2xslt-maven-plugin", EProjectType.MAVEN_PLUGIN, false, false, "2.8.0"),
  PH_SCHEDULE ("ph-schedule", EProjectType.JAVA_LIBRARY, false, false, "1.6.3"),
  PH_SCHEMATRON ("ph-schematron", EProjectType.JAVA_LIBRARY, true, false, "2.8.4"),
  PH_SCHEMATRON_TESTFILES ("ph-schematron-testfiles", EProjectType.JAVA_LIBRARY, false, false, "1.1.1"),
  PH_SCHEMATRON_VALIDATOR ("ph-schematron-validator", EProjectType.JAVA_LIBRARY, false, false, "2.8.0"),
  PH_SCOPES ("ph-scopes", EProjectType.JAVA_LIBRARY, false, false, "6.6.0"),
  PH_SETTINGS ("ph-settings", EProjectType.JAVA_LIBRARY, false, false, "1.1.1"),
  PH_TINYMCE4 ("ph-tinymce4", EProjectType.JAVA_LIBRARY, false, false, "0.3.3"),
  PH_UBL ("ph-ubl", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_UBL_JAXB_PLUGIN ("ph-ubl-jaxb-plugin", EProjectType.JAXB_PLUGIN, false, false, "1.2.0"),
  PH_UBL20 ("ph-ubl20", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_UBL20_CODELISTS ("ph-ubl20-codelists", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_UBL21 ("ph-ubl21", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_UBL21_CODELISTS ("ph-ubl21-codelists", EProjectType.JAVA_LIBRARY, false, false, "3.3.0"),
  PH_VALIDATION ("ph-validation", EProjectType.JAVA_LIBRARY, false, false, "3.3.3"),
  PH_WEB ("ph-web", EProjectType.JAVA_LIBRARY, false, false, "6.0.2"),
  PH_WEBAPP_DEMO ("ph-webapp-demo", EProjectType.JAVA_WEB_APPLICATION, false, false, null),
  PH_WEBBASICS ("ph-webbasics", EProjectType.JAVA_LIBRARY, false, false, "3.5.0"),
  PH_WEBCTRLS ("ph-webctrls", EProjectType.JAVA_LIBRARY, false, false, "2.5.1"),
  PH_WEBSCOPES ("ph-webscopes", EProjectType.JAVA_LIBRARY, false, false, "6.6.1"),
